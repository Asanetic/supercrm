...
//"primkey" , "record_id" , "task_title" , "task_description" , "task_type" , "task_priority" , "task_status" , "client_id" , "lead_id" , "deal_id" , "due_date" , "completed_on" , "task_notes" , "created_at" , "assigned_sales_rep" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "tasks" => ["primkey","record_id","task_title","task_description","task_type","task_priority","task_status","client_id","lead_id","deal_id","due_date","completed_on","task_notes","created_at","assigned_sales_rep","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "tasks" => [
              "Basic Information" => ["primkey","record_id","task_title","task_description","task_type","task_priority","task_status","client_id","lead_id"]
          ]
      ...
      "print_tables" => merge_setting(["tasks"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["deal_id","due_date","completed_on","task_notes","created_at","assigned_sales_rep","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["task_description","task_notes"], "textarea_array"),
      ...
      "datetime_columns" => merge_setting(["due_date","created_at","updated_at"], "datetime_columns"),

      "rename_cols_array" => merge_setting(
          ["client_id" => "Full Name","deal_id" => "Deal Title","assigned_sales_rep" => "Full Name"],
          "rename_cols_array"
      ),
      ...
      "new_label_buttons_arr" => merge_setting([
          "tasks" => "plus-circle:New Tasks:{`Tasks / \${tasksNode?.task_description}`}"
    ...
    "import"=>[
        ...
        "tasks"=>[
            ...
            "csv"=>"primkey,record_id,task_title,task_description,task_type,task_priority,task_status,client_id,lead_id,deal_id,due_date,completed_on,task_notes,created_at,assigned_sales_rep,updated_at,hive_site_id,hive_site_name",
