...
//"primkey" , "record_id" , "message_number" , "related_record_id" , "recipient_name" , "recipient_phone" , "recipient_email" , "message_channel" , "message_subject" , "message_content" , "message_status" , "delivery_status" , "request_source" , "request_id" , "sent_by" , "scheduled_for" , "sent_on" , "delivered_on" , "read_on" , "failed_on" , "failure_reason" , "created_on" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="smart_messages";
  $__page_title ="Smart Messages";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"smartmessages",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"smartmessageslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "smart_messages" => ["primkey","record_id","message_number","related_record_id","recipient_name","recipient_phone","recipient_email","message_channel","message_subject","message_content","message_status","delivery_status","request_source","request_id","sent_by","scheduled_for","sent_on","delivered_on","read_on","failed_on","failure_reason","created_on","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "smart_messages" => [
              "Basic Information" => ["primkey","record_id","message_number","related_record_id","recipient_name","recipient_phone","recipient_email","message_channel","message_subject"]
          ]
      ...
      "print_tables" => merge_setting(["smart_messages"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["message_content","message_status","delivery_status","request_source","request_id","sent_by","scheduled_for","sent_on","delivered_on","read_on","failed_on","failure_reason","created_on","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["message_content"], "textarea_array"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "smart_messages" => "plus-circle:New Smart Messages:{`Smart Messages / \${smart_messagesNode?.related_record_id}`}"
    ...
    "import"=>[
        ...
        "smart_messages"=>[
            ...
            "csv"=>"primkey,record_id,message_number,related_record_id,recipient_name,recipient_phone,recipient_email,message_channel,message_subject,message_content,message_status,delivery_status,request_source,request_id,sent_by,scheduled_for,sent_on,delivered_on,read_on,failed_on,failure_reason,created_on,created_at,updated_at,hive_site_id,hive_site_name",
