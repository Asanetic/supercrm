  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "print_tables" => merge_setting(["settings"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["default_approval_workflow","system_status","setting_remarks","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["setting_remarks"], "textarea_array"),
