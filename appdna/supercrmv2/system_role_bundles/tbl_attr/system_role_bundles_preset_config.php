...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  $__page_title ="System Role Bundles";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"systemrolebundles",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"systemrolebundleslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "system_role_bundles" => ["primkey","record_id","bundle_id","bundle_name","remark","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "system_role_bundles" => [
              "Basic Information" => ["primkey","record_id","bundle_id","bundle_name","remark","hive_site_id","hive_site_name"]
          ]
      ...
      "print_tables" => merge_setting(["system_role_bundles"], "print_tables"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "system_role_bundles" => "plus-circle:New System Role Bundles:{`System Role Bundles / \${system_role_bundlesNode?.bundle_name}`}"
    ...
    "import"=>[
        ...
        "system_role_bundles"=>[
            ...
            "csv"=>"primkey,record_id,bundle_id,bundle_name,remark,hive_site_id,hive_site_name",
