...
////1. system_module_manifest_

//"primkey" , "record_id" , "component_name" , "module_key" , "module_name" , "permission_type" , "capability_key" , "access_name" , "relative_path" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  $core_module_configs_=[
    ...
    "table_alias" =>"systemmodulemanifest",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"systemmodulemanifestlist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "system_module_manifest_" => ["primkey","record_id","component_name","module_key","module_name","permission_type","capability_key","access_name","relative_path","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "system_module_manifest_" => [
              "Basic Information" => ["primkey","record_id","component_name","module_key","module_name","permission_type","capability_key","access_name","relative_path"]
          ]
      ...
      "print_tables" => merge_setting(["system_module_manifest_"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "datetime_columns" => merge_setting([], "datetime_columns"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "system_module_manifest_" => "plus-circle:New System Module Manifest :{`System Module Manifest  / \${system_module_manifest_Node?.module_key}`}"
    ...
    "import"=>[
        ...
        "system_module_manifest_"=>[
            ...
            "csv"=>"primkey,record_id,component_name,module_key,module_name,permission_type,capability_key,access_name,relative_path,hive_site_id,hive_site_name",
