...
////1. smart_payment_requests

//"primkey" , "record_id" , "request_reference" , "request_title" , "related_module" , "related_record_id" , "payer_name" , "payer_phone" , "payer_email" , "amount_requested" , "amount_paid" , "balance_amount" , "payment_shortcode" , "payment_link" , "request_notes" , "expiry_date" , "request_status" , "created_by" , "created_on" , "updated_on" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="smart_payment_requests";
  $__page_title ="Smart Payment Requests";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"smartpaymentrequests",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"smartpaymentrequestslist",
  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "print_tables" => merge_setting(["smart_payment_requests"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["amount_requested","amount_paid","balance_amount","payment_shortcode","payment_link","request_notes","expiry_date","request_status","created_by","created_on","updated_on","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["request_notes"], "textarea_array"),
      ...
      "datetime_columns" => merge_setting(["expiry_date","updated_on","created_at","updated_at"], "datetime_columns"),
      ...
      "rename_tables_array" => merge_setting([
          "smart_payment_requests" => "Smart Payment Requests"
      ], "rename_tables_array"),

      "new_label_buttons_arr" => merge_setting([
          "smart_payment_requests" => "plus-circle:New Smart Payment Requests:{`Smart Payment Requests / \${smart_payment_requestsNode?.request_title}`}"
    ...
    "import"=>[
        ...
        "smart_payment_requests"=>[
            ...
            "csv"=>"primkey,record_id,request_reference,request_title,related_module,related_record_id,payer_name,payer_phone,payer_email,amount_requested,amount_paid,balance_amount,payment_shortcode,payment_link,request_notes,expiry_date,request_status,created_by,created_on,updated_on,created_at,updated_at,hive_site_id,hive_site_name",
