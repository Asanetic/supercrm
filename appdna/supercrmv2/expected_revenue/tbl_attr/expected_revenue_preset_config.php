  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    "db_schema" => [
        ...
        "custom_tbl_cols" => [
           "expected_revenue" => ["name", "tel","email"]
        ],
    ...
    [
      ...
      "hidden_inputs" => merge_setting(["updated_at","assigned_to","lead_id"], "hidden_inputs"),
      ...
      "dynamic_drop_down_array" => merge_setting(["revenue_month"], "dynamic_drop_down_array"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "expected_revenue" => "plus-circle:New Expected Revenue:{`Expected Revenue / \${expected_revenueNode?.revenue_title}`}"
