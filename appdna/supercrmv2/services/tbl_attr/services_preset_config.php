...
//"primkey" , "record_id" , "service_code" , "service_name" , "category" , "price_range" , "service_price" , "service_description" , "billing_type" , "service_status" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "services" => ["primkey","record_id","service_code","service_name","category","price_range","service_price","service_description","billing_type","service_status","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "services" => [
              "Basic Information" => ["primkey","record_id","service_code","service_name","category","price_range","service_price","billing_type","service_status"]
          ]
      ...
      "print_tables" => merge_setting(["services"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["service_status","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["service_description"], "textarea_array"),

      "content_editable" => merge_setting([], "content_editable"),

      "static_drop_down_array" => merge_setting([], "static_drop_down_array"),

      "dynamic_drop_down_array" => merge_setting(["service_status"], "dynamic_drop_down_array"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "services" => "plus-circle:New Services:{`Services / \${servicesNode?.service_name}`}"
    ...
    "import"=>[
        ...
        "services"=>[
            ...
            "csv"=>"primkey,record_id,service_code,service_name,category,price_range,service_price,service_description,billing_type,service_status,created_at,updated_at,hive_site_id,hive_site_name",
