  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "clients" => ["primkey","record_id","full_name","business_name","phone_number","alternative_phone_number","email_address","website_url","industry_type","lead_source","country_name","city_name","client_status","converted_lead_id","assigned_sales_rep","business_address","tax_number","profile_photo","notes","last_contact_date","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "clients" => [
              "Basic Information" => ["primkey","record_id","full_name","business_name","phone_number","alternative_phone_number","email_address","website_url","industry_type"]
          ]
      ...
      "print_tables" => merge_setting(["clients"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["lead_source","country_name","city_name","client_status","converted_lead_id","assigned_sales_rep","business_address","tax_number","notes","last_contact_date","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "datetime_columns" => merge_setting(["last_contact_date","created_at","updated_at"], "datetime_columns"),

      "rename_cols_array" => merge_setting(
          ["record_id" => "Recipient Name","converted_lead_id" => "Full Name"],
          "rename_cols_array"
      ),
      ...
      "new_label_buttons_arr" => merge_setting([
          "clients" => "plus-circle:New Clients:{`Clients / \${clientsNode?.business_name}`}"
    ...
    "import"=>[
        ...
        "clients"=>[
            ...
            "csv"=>"primkey,record_id,full_name,business_name,phone_number,alternative_phone_number,email_address,website_url,industry_type,lead_source,country_name,city_name,client_status,converted_lead_id,assigned_sales_rep,business_address,tax_number,profile_photo,notes,last_contact_date,created_at,updated_at,hive_site_id,hive_site_name",
