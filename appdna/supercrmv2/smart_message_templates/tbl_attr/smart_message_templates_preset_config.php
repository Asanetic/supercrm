...
////1. smart_message_templates

//"primkey" , "record_id" , "template_name" , "template_code" , "template_category" , "message_channel" , "subject" , "message_content" , "template_status" , "created_by" , "last_updated_by" , "created_on" , "updated_on" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="smart_message_templates";
  $__page_title ="Smart Message Templates";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"smartmessagetemplates",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"smartmessagetemplateslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "smart_message_templates" => ["primkey","record_id","template_name","template_code","template_category","message_channel","subject","message_content","template_status","created_by","last_updated_by","created_on","updated_on","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "smart_message_templates" => [
              "Basic Information" => ["primkey","record_id","template_name","template_code","template_category","message_channel","subject","message_content","template_status"]
          ]
      ...
      "print_tables" => merge_setting(["smart_message_templates"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["created_by","last_updated_by","created_on","updated_on","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["message_channel","message_content"], "textarea_array"),
      ...
      "rename_tables_array" => merge_setting([
          "smart_message_templates" => "Smart Message Templates"
      ], "rename_tables_array"),

      "new_label_buttons_arr" => merge_setting([
          "smart_message_templates" => "plus-circle:New Smart Message Templates:{`Smart Message Templates / \${smart_message_templatesNode?.template_code}`}"
    ...
    "import"=>[
        ...
        "smart_message_templates"=>[
            ...
            "csv"=>"primkey,record_id,template_name,template_code,template_category,message_channel,subject,message_content,template_status,created_by,last_updated_by,created_on,updated_on,created_at,updated_at,hive_site_id,hive_site_name",
