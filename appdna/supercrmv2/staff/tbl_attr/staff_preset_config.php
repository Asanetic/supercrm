  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "print_tables" => merge_setting(["staff"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["current_outstanding_balance","staff_status","registered_on","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
