...
//"primkey" , "record_id" , "deal_title" , "deal_description" , "client_id" , "deal_source" , "deal_value" , "expected_close_date" , "pipeline_stage" , "deal_stage" , "deal_status" , "assigned_sales_rep" , "priority_level" , "deal_probability" , "next_follow_up_date" , "deal_notes" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "deals" => ["primkey","record_id","deal_title","deal_description","client_id","deal_source","deal_value","expected_close_date","pipeline_stage","deal_stage","deal_status","assigned_sales_rep","priority_level","deal_probability","next_follow_up_date","deal_notes","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "deals" => [
              "Basic Information" => ["primkey","record_id","deal_title","deal_description","client_id","deal_source","deal_value","expected_close_date","pipeline_stage"]
          ]
      ...
      "print_tables" => merge_setting(["deals"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["deal_stage","deal_status","assigned_sales_rep","priority_level","deal_probability","next_follow_up_date","deal_notes","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["deal_description","deal_notes"], "textarea_array"),

      "content_editable" => merge_setting([], "content_editable"),

      "static_drop_down_array" => merge_setting([], "static_drop_down_array"),

      "dynamic_drop_down_array" => merge_setting(["deal_probability","deal_status","priority_level"], "dynamic_drop_down_array"),

      "password_columns" => merge_setting([], "password_columns"),

      "title_columns" => merge_setting(["deal_title"], "title_columns"),

      "date_columns" => merge_setting([], "date_columns"),

      "datetime_columns" => merge_setting(["expected_close_date","next_follow_up_date","created_at","updated_at"], "datetime_columns"),

      "rename_cols_array" => merge_setting(
          ["client_id"=>"Client","deal_title"=>"Deal name:col-md-12"],
          "rename_cols_array"
      ),
      ...
      "new_label_buttons_arr" => merge_setting([
          "deals" => "plus-circle:Create deal:{`Deal profile / \${dealsNode?.deal_title}`}"
    ...
    "import"=>[
        ...
        "deals"=>[
            ...
            "csv"=>"primkey,record_id,deal_title,deal_description,client_id,deal_source,deal_value,expected_close_date,pipeline_stage,deal_stage,deal_status,assigned_sales_rep,priority_level,deal_probability,next_follow_up_date,deal_notes,created_at,updated_at,hive_site_id,hive_site_name",
