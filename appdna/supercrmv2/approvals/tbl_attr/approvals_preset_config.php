  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "print_tables" => merge_setting(["approvals"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["approval_status","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
