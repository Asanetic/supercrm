...
//smart messages
smart_messages:recipient_name|related_record_id:record_id:clients,related_record_id:record_id:leads

// CLIENTS RELATIONSHIPS

clients:full_name|record_id:client_id:deals(Deals),record_id:client_id:quotations(Quotations),record_id:client_id:invoices(Invoices),record_id:client_id:payments(Payments),record_id:client_id:tasks(Tasks),record_id:client_id:activities(Activities), record_id:client_id:expected_revenue,converted_lead_id:record_id:leads(Lead profile),record_id:related_record_id:smart_messages(Message history)


// LEADS RELATIONSHIPS

leads:full_name|converted_client_id:record_id:clients(Client profile),record_id:lead_id:tasks,related_record_id,record_id:related_record_id:smart_messages(Message history)

 //Table name : clients

// columns : "primkey" , "record_id" , "full_name" , "business_name" , "phone_number" , "alternative_phone_number" , "email_address" , "website_url" , "industry_type" , "lead_source" , "country_name" , "city_name" , "client_status" , "converted_lead_id" , "assigned_sales_rep" , "business_address" , "tax_number" , "profile_photo" , "notes" , "last_contact_date" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , 

//Table name : leads

// columns : "primkey" , "record_id" , "lead_title" , "full_name" , "business_name" , "phone_number" , "alternative_phone_number" , "email_address" , "website_url" , "industry_type" , "lead_source" , "lead_status" , "converted_client_id" , "lead_temperature" , "assigned_sales_rep" , "estimated_deal_value" , "expected_conversion_date" , "country_name" , "city_name" , "business_address" , "notes" , "next_follow_up_date" , "last_contact_date" , "profile_photo" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , 
...
$interlink_mapping_lists=[
    ...
    "smart_messages"=>[
        ...
        "smart_messages_clients"=>[
            "filter_str"=>"{recordId:btoa(smart_messagesNode?.related_record_id)    }",
            "module_name"=>"Clients",
            "list_title"=>"Clients",
            "event_name"=>"",
            "custom"=>false,
    ...
    "clients"=>[
        ...
        "clients_leads"=>[
            "filter_str"=>"{recordId:btoa(clientsNode?.converted_lead_id)                                }",
            "module_name"=>"Leads",
            "list_title"=>"Lead profile",
            "event_name"=>"",
            "custom"=>false,
            "external"=>true,
            "enabled"=>true,
        ...
        "clients_smart_messages"=>[
            "filter_str"=>"{relatedRecordId:btoa(clientsNode?.record_id)                                    }",
            "module_name"=>"SmartMessages",
            "list_title"=>"Message history",
            "event_name"=>"",
            "custom"=>false,
            "external"=>true,
            "enabled"=>true,
    ...
    "leads"=>[
        ...
        "leads_clients"=>[
            "filter_str"=>"{recordId:btoa(leadsNode?.converted_client_id)    }",
            "module_name"=>"Clients",
            "list_title"=>"Client profile",
            "event_name"=>"",
            "custom"=>false,
            "external"=>true,
            "enabled"=>true,
        ...
        "leads_tasks"=>[
            "filter_str"=>"{leadId:btoa(leadsNode?.record_id)        }",
            "module_name"=>"Tasks",
            "list_title"=>"Tasks",
            "event_name"=>"",
            "custom"=>false,
        ...
        "leads_smart_messages"=>[
            "filter_str"=>"{relatedRecordId:btoa(leadsNode?.record_id)            }",
            "module_name"=>"SmartMessages",
            "list_title"=>"Message history",
            "event_name"=>"",
            "custom"=>false,
...
$interlink_mapping_profile=[
    ...
    "clients"=>[
        ...
        "clients_smart_messages"=>[
            ...
            "event_name"=>"",
            "event_path"=>"",
            "list_table_name"=>"smart_messages",
        ],
...
$connection_col_mapping=[
    ...
    "smart_messages"=>[
        "related_record_id" => "leads:record_id:full_name:apiRoutes.leads.base",
    ],

    "clients"=>[
        "record_id" => "smart_messages:related_record_id:recipient_name:apiRoutes.smartmessages.base",
        "converted_lead_id" => "leads:record_id:full_name:apiRoutes.leads.base",
    ],

    "leads"=>[
        "converted_client_id" => "clients:record_id:full_name:apiRoutes.clients.base",
        "record_id" => "smart_messages:related_record_id:recipient_name:apiRoutes.smartmessages.base",
    ],
...
$list_drop_down_mappper=[
    ...
    "smart_messages"=>[
        ...
        "list : Clients"=>[
            "fe"=>"viewClients({childCol:`recordId`,parentColVal:listsmart_messages_result.related_record_id,parentName:listsmart_messages_result.recipient_name})",
        ...
        "list : Leads"=>[
            "fe"=>"viewLeads({childCol:`recordId`,parentColVal:listsmart_messages_result.related_record_id,parentName:listsmart_messages_result.recipient_name})",
    ...
    "clients"=>[
        ...
        "list : Lead profile"=>[
            "fe"=>"viewLeads({childCol:`recordId`,parentColVal:listclients_result.converted_lead_id,parentName:listclients_result.full_name})",
            "file"=>"leads-automapper",
            "module_name"=>"Leads",
            "functionType"=>"autoMapper",
            "parentName"=>"LeadsList",
        ...
        "list : Message history"=>[
            "fe"=>"viewSmartMessages({childCol:`relatedRecordId`,parentColVal:listclients_result.record_id,parentName:listclients_result.full_name})",
            "file"=>"smart_messages-automapper",
            "module_name"=>"SmartMessages",
            "functionType"=>"autoMapper",
            "parentName"=>"SmartMessagesList",
            "parentTable"=>"clients",
            "childTable"=>"smart_messages",
            "fileTitle"=>"Message history",
            "alias"=>"smartmessages",
            "functionType"=>"autoMapper",
            "basepath"=>"../../smartmessages/logicControl"
        ],
    ...
    "leads"=>[
        ...
        "list : Client profile"=>[
            "fe"=>"viewClients({childCol:`recordId`,parentColVal:listleads_result.converted_client_id,parentName:listleads_result.full_name})",
            "file"=>"clients-automapper",
            "module_name"=>"Clients",
            "functionType"=>"autoMapper",
            "parentName"=>"ClientsList",
        ...
        "list : Tasks"=>[
            "fe"=>"viewTasks({childCol:`leadId`,parentColVal:listleads_result.record_id,parentName:listleads_result.full_name})",
            "file"=>"tasks-automapper",
            "module_name"=>"Tasks",
            "functionType"=>"autoMapper",
            "parentName"=>"TasksList",
        ...
        "list : Message history"=>[
            "fe"=>"viewSmartMessages({childCol:`relatedRecordId`,parentColVal:listleads_result.record_id,parentName:listleads_result.full_name})",
            "file"=>"smart_messages-automapper",
            "module_name"=>"SmartMessages",
            "functionType"=>"autoMapper",
            "parentName"=>"SmartMessagesList",
...
$profile_mapper_buttons_list_=[
    ...
    "smart_messages"=>[
        ...
        "list : View Clients"=>[
            "module_name"=>"Clients",
            "fe"=>"viewClients({childCol:`recordId`,parentColVal:smart_messagesNode.related_record_id,parentName:smart_messagesNode.recipient_name})",
            "alias"=>"clients",
            "file"=>"clients-automapper",
            "functionType"=>"autoMapper",
            "parentName"=>"ClientsList",
        ...
        "list : View Leads"=>[
            "module_name"=>"Leads",
            "fe"=>"viewLeads({childCol:`recordId`,parentColVal:smart_messagesNode.related_record_id,parentName:smart_messagesNode.recipient_name})",
            "alias"=>"leads",
            "file"=>"leads-automapper",
            "functionType"=>"autoMapper",
            "parentName"=>"LeadsList",
    ...
    "clients"=>[
        ...
        "list : View Lead profile"=>[
            "module_name"=>"Leads",
            "fe"=>"viewLeads({childCol:`recordId`,parentColVal:clientsNode.converted_lead_id,parentName:clientsNode.full_name})",
            "alias"=>"leads",
            "file"=>"leads-automapper",
            "functionType"=>"autoMapper",
            "parentName"=>"LeadsList",
        ...
        "list : View Message history"=>[
            "module_name"=>"SmartMessages",
            "fe"=>"viewSmartMessages({childCol:`relatedRecordId`,parentColVal:clientsNode.record_id,parentName:clientsNode.full_name})",
            "alias"=>"smartmessages",
            "file"=>"smart_messages-automapper",
            "functionType"=>"autoMapper",
            "parentName"=>"SmartMessagesList",
    ...
    "leads"=>[
        ...
        "list : View Client profile"=>[
            "module_name"=>"Clients",
            "fe"=>"viewClients({childCol:`recordId`,parentColVal:leadsNode.converted_client_id,parentName:leadsNode.full_name})",
            "alias"=>"clients",
            "file"=>"clients-automapper",
            "functionType"=>"autoMapper",
            "parentName"=>"ClientsList",
        ...
        "list : View Tasks"=>[
            "module_name"=>"Tasks",
            "fe"=>"viewTasks({childCol:`leadId`,parentColVal:leadsNode.record_id,parentName:leadsNode.full_name})",
            "alias"=>"tasks",
            "file"=>"tasks-automapper",
            "functionType"=>"autoMapper",
            "parentName"=>"TasksList",
        ...
        "list : View Message history"=>[
            "module_name"=>"SmartMessages",
            "fe"=>"viewSmartMessages({childCol:`relatedRecordId`,parentColVal:leadsNode.record_id,parentName:leadsNode.full_name})",
            "alias"=>"smartmessages",
            "file"=>"smart_messages-automapper",
            "functionType"=>"autoMapper",
            "parentName"=>"SmartMessagesList",
    ...
    "clients"=>[
        ...
        "leads"=>[
            "_clients_full_name_record_id"=>"clientsNode?.full_name",
            "record_id"=>"clientsNode?.converted_lead_id",
        ],

        "smart_messages"=>[
            "_clients_full_name_related_record_id"=>"clientsNode?.full_name",
            "related_record_id"=>"clientsNode?.record_id",
        ],
