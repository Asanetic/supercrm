...
//"primkey" , "manikey" , "page_group" , "site_id" , "page_url" , "hive_site_id" , "hive_site_name" , "project_id" , "project_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="page_manifest_";
  $__page_title ="Page Manifest ";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"pagemanifest",     
    "primary_key"=>"primkey",
    "record_id"=>"manikey",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"pagemanifestlist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "page_manifest_" => ["primkey","manikey","page_group","site_id","page_url","hive_site_id","hive_site_name","project_id","project_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "page_manifest_" => [
              "Basic Information" => ["primkey","manikey","page_group","site_id","page_url","hive_site_id","hive_site_name","project_id","project_name"]
          ]
      ...
      "print_tables" => merge_setting(["page_manifest_"], "print_tables"),
      ...
      "rename_tables_array" => merge_setting([
          "page_manifest_" => "Page Manifest "
      ], "rename_tables_array"),

      "new_label_buttons_arr" => merge_setting([
          "page_manifest_" => "plus-circle:New Page Manifest :{`Page Manifest  / \${page_manifest_Node?.site_id}`}"
    ...
    "import"=>[
        ...
        "page_manifest_"=>[
            ...
            "csv"=>"primkey,manikey,page_group,site_id,page_url,hive_site_id,hive_site_name,project_id,project_name",
