...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="smart_payments";
  $__page_title ="Smart Payments";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"smartpayments",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"smartpaymentslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "form_input_segmentation_arr" => merge_setting([
          "smart_payments" => [
              "Basic Information" => ["primkey","record_id","payment_date","transaction_code","amount_paid","payer_name","payer_phone","request_reference","payment_description"]
          ]
      ...
      "print_tables" => merge_setting(["smart_payments"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["related_module","payment_reference","related_record_id","receipt_number","payer_email","payment_method","payment_channel","currency","payment_notes","payment_status","processed_by","created_on","updated_on","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["payment_description","payment_notes"], "textarea_array"),
      ...
      "datetime_columns" => merge_setting(["payment_date","updated_on","created_at","updated_at"], "datetime_columns"),
      ...
      "rename_tables_array" => merge_setting([
          "smart_payments" => "Smart Payments"
      ], "rename_tables_array"),

      "new_label_buttons_arr" => merge_setting([
          "smart_payments" => "plus-circle:New Smart Payments:{`Smart Payments / \${smart_paymentsNode?.transaction_code}`}"
    ...
    "import"=>[
        ...
        "smart_payments"=>[
            ...
            "csv"=>"primkey,record_id,payment_date,transaction_code,amount_paid,payer_name,payer_phone,request_reference,payment_description,related_module,payment_reference,related_record_id,receipt_number,payer_email,payment_method,payment_channel,currency,payment_notes,payment_status,processed_by,created_on,updated_on,created_at,updated_at,hive_site_id,hive_site_name",
