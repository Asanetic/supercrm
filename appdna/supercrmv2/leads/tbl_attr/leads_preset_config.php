  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "skip_cols_list" => merge_setting(["industry_type","lead_source","lead_status","converted_client_id","lead_temperature","assigned_sales_rep","estimated_deal_value","expected_conversion_date","country_name","city_name","business_address","notes","next_follow_up_date","last_contact_date","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
