...
//"primkey" , "record_id" , "product_name" , "price_range" , "unit_price" , "product_code" , "category" , "product_description" , "product_image" , "discount_price" , "tax_percentage" , "currency_code" , "stock_quantity" , "product_status" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="products";
  $__page_title ="Products";
  ...
  $core_module_configs_=[
    ...
    "api_endpoint_name"=>"productslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "products" => ["primkey","record_id","product_name","price_range","unit_price","product_code","category","product_description","product_image","discount_price","tax_percentage","currency_code","stock_quantity","product_status","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "products" => [
              "Basic Information" => ["primkey","record_id","product_name","price_range","unit_price","product_code","category","product_description","product_image"]
          ]
      ], "form_input_segmentation_arr"),

      "image_columns" => merge_setting(["product_image"], "image_columns"),

      "default_col_class" => "col-md-4",

      "hidden_inputs" => merge_setting(["updated_at"], "hidden_inputs"),

      "print_tables" => merge_setting(["products"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["discount_price","tax_percentage","currency_code","stock_quantity","product_status","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["product_description"], "textarea_array"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "products" => "plus-circle:Create product :{`Product details / \${productsNode?.product_name}`}"
    ...
    "import"=>[
        ...
        "products"=>[
            ...
            "csv"=>"primkey,record_id,product_name,price_range,unit_price,product_code,category,product_description,product_image,discount_price,tax_percentage,currency_code,stock_quantity,product_status,created_at,updated_at,hive_site_id,hive_site_name",
