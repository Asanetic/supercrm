...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  $__page_title ="User Bundle Role Functions";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"userbundlerolefunctions",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"userbundlerolefunctionslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "user_bundle_role_functions" => ["primkey","record_id","bundle_id","bundle_name","role_id","role_name","remark","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "user_bundle_role_functions" => [
              "Basic Information" => ["primkey","record_id","bundle_id","bundle_name","role_id","role_name","remark","hive_site_id","hive_site_name"]
          ]
      ...
      "print_tables" => merge_setting(["user_bundle_role_functions"], "print_tables"),
      ...
      "textarea_array" => merge_setting(["remark"], "textarea_array"),
      ...
      "rename_tables_array" => merge_setting([
          "user_bundle_role_functions" => "User Bundle Role Functions"
      ], "rename_tables_array"),

      "new_label_buttons_arr" => merge_setting([
          "user_bundle_role_functions" => "plus-circle:New User Bundle Role Functions:{`User Bundle Role Functions / \${user_bundle_role_functionsNode?.bundle_name}`}"
    ...
    "import"=>[
        ...
        "user_bundle_role_functions"=>[
            ...
            "csv"=>"primkey,record_id,bundle_id,bundle_name,role_id,role_name,remark,hive_site_id,hive_site_name",
