...
//"primkey" , "record_id" , "quotation_number" , "quotation_title" , "quotation_description" , "client_id" , "deal_id" , "quotation_amount" , "tax_amount" , "discount_amount" , "quotation_status" , "quotation_issued_on" , "quotation_expiry_date" , "quotation_notes" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="quotations";
  $__page_title ="Quotations";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"quotations",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"quotationslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "quotations" => ["primkey","record_id","quotation_number","quotation_title","quotation_description","client_id","deal_id","quotation_amount","tax_amount","discount_amount","quotation_status","quotation_issued_on","quotation_expiry_date","quotation_notes","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "quotations" => [
              "Basic Information" => ["primkey","record_id","quotation_number","quotation_title","quotation_description","client_id","deal_id","quotation_amount","tax_amount"]
          ]
      ...
      "print_tables" => merge_setting(["quotations"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["discount_amount","quotation_status","quotation_issued_on","quotation_expiry_date","quotation_notes","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["quotation_description","quotation_notes"], "textarea_array"),
      ...
      "datetime_columns" => merge_setting(["quotation_expiry_date","created_at","updated_at"], "datetime_columns"),

      "rename_cols_array" => merge_setting(
          ["client_id" => "Full Name","deal_id" => "Deal Title","record_id" => "Invoice Title"],
          "rename_cols_array"
      ),
      ...
      "new_label_buttons_arr" => merge_setting([
          "quotations" => "plus-circle:New Quotations:{`Quotations / \${quotationsNode?.quotation_title}`}"
    ...
    "import"=>[
        ...
        "quotations"=>[
            ...
            "csv"=>"primkey,record_id,quotation_number,quotation_title,quotation_description,client_id,deal_id,quotation_amount,tax_amount,discount_amount,quotation_status,quotation_issued_on,quotation_expiry_date,quotation_notes,created_at,updated_at,hive_site_id,hive_site_name",
