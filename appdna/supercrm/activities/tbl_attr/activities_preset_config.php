  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "skip_cols_list" => ["activity_date","next_action_date","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "textarea_array" => ["activity_description"],
        ...
        "datetime_columns" => ["activity_date","next_action_date","created_at","updated_at"],

		"rename_cols_array" => ["client_id" => "Full Name","deal_id" => "Deal Title","performed_by" => "Full Name"],
