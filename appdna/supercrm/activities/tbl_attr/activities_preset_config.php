...
//"primkey" , "record_id" , "client_id" , "deal_id" , "activity_type" , "activity_title" , "activity_description" , "activity_status" , "performed_by" , "activity_date" , "next_action_date" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="activities";
  $__page_title ="Activities";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"activities",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"activitieslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "activities" => ["primkey","record_id","client_id","deal_id","activity_type","activity_title","activity_description","activity_status","performed_by","activity_date","next_action_date","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "activities" => [
              "Basic Information" => ["primkey","record_id","client_id","deal_id","activity_type","activity_title","activity_description","activity_status","performed_by"]
          ]
      ...
      "print_tables" => merge_setting(["activities"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["activity_date","next_action_date","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["activity_description"], "textarea_array"),
      ...
      "datetime_columns" => merge_setting(["activity_date","next_action_date","created_at","updated_at"], "datetime_columns"),

      "rename_cols_array" => merge_setting(
          ["client_id" => "Full Name","deal_id" => "Deal Title","performed_by" => "Full Name"],
          "rename_cols_array"
      ),
      ...
      "new_label_buttons_arr" => merge_setting([
          "activities" => "plus-circle:New Activities:{`Activities / \${activitiesNode?.deal_id}`}"
    ...
    "import"=>[
        ...
        "activities"=>[
            ...
            "csv"=>"primkey,record_id,client_id,deal_id,activity_type,activity_title,activity_description,activity_status,performed_by,activity_date,next_action_date,created_at,updated_at,hive_site_id,hive_site_name",
