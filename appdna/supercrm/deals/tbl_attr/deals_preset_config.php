  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "skip_cols_list" => ["deal_stage","deal_status","assigned_sales_rep","priority_level","deal_probability","next_follow_up_date","deal_notes","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "textarea_array" => ["deal_description","deal_notes"],
        ...
        "datetime_columns" => ["expected_close_date","next_follow_up_date","created_at","updated_at"],

		"rename_cols_array" => ["client_id" => "Full Name","record_id" => "Activity Title"],
