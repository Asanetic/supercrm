  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "skip_cols_list" => ["expected_close_date","probability_percent","revenue_source_type","revenue_title","invoice_id","lead_id","revenue_status","revenue_description","assigned_to","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "textarea_array" => ["revenue_description"],
        ...
        "datetime_columns" => ["expected_close_date","created_at","updated_at"],

		"rename_cols_array" => ["client_id" => "Full Name","deal_id" => "Deal Title","invoice_id" => "Invoice Title","payment_ref_no" => "Transaction Ref","record_id" => "Activity Title"],
