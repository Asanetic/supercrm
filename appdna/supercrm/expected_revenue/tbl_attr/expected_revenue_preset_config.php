...
//"primkey" , "record_id" , "revenue_month" , "client_id" , "deal_id" , "expected_amount" , "currency_code" , "payment_status" , "payment_ref_no" , "expected_close_date" , "probability_percent" , "revenue_source_type" , "revenue_title" , "invoice_id" , "lead_id" , "revenue_status" , "revenue_description" , "assigned_to" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="expected_revenue";
  $__page_title ="Expected Revenue";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"expectedrevenue",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"expectedrevenuelist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "expected_revenue" => ["primkey","record_id","revenue_month","client_id","deal_id","expected_amount","currency_code","payment_status","payment_ref_no","expected_close_date","probability_percent","revenue_source_type","revenue_title","invoice_id","lead_id","revenue_status","revenue_description","assigned_to","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "expected_revenue" => [
              "Basic Information" => ["primkey","record_id","revenue_month","client_id","deal_id","expected_amount","currency_code","payment_status","payment_ref_no"]
          ]
      ...
      "print_tables" => merge_setting(["expected_revenue"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["expected_close_date","probability_percent","revenue_source_type","revenue_title","invoice_id","lead_id","revenue_status","revenue_description","assigned_to","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["revenue_description"], "textarea_array"),

      "content_editable" => merge_setting([], "content_editable"),

      "static_drop_down_array" => merge_setting([], "static_drop_down_array"),

      "dynamic_drop_down_array" => merge_setting(["revenue_month","probability_percent","revenue_status","payment_status"], "dynamic_drop_down_array"),
      ...
      "datetime_columns" => merge_setting(["expected_close_date","created_at","updated_at"], "datetime_columns"),

      "rename_cols_array" => merge_setting(
          ["client_id" => "Full Name","deal_id" => "Deal Title","invoice_id" => "Invoice Title","payment_ref_no" => "Transaction Ref","record_id" => "Activity Title"],
          "rename_cols_array"
      ),
      ...
      "new_label_buttons_arr" => merge_setting([
          "expected_revenue" => "plus-circle:New Expected Revenue:{`Expected Revenue / \${expected_revenueNode?.client_id}`}"
    ...
    "import"=>[
        ...
        "expected_revenue"=>[
            ...
            "csv"=>"primkey,record_id,revenue_month,client_id,deal_id,expected_amount,currency_code,payment_status,payment_ref_no,expected_close_date,probability_percent,revenue_source_type,revenue_title,invoice_id,lead_id,revenue_status,revenue_description,assigned_to,created_at,updated_at,hive_site_id,hive_site_name",
