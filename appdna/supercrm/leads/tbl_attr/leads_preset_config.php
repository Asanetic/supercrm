  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "leads" => ["primkey","record_id","lead_title","full_name","business_name","phone_number","alternative_phone_number","email_address","website_url","industry_type","lead_source","lead_status","lead_temperature","assigned_sales_rep","estimated_deal_value","expected_conversion_date","country_name","city_name","business_address","notes","next_follow_up_date","last_contact_date","profile_photo","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "leads" => [
              "Basic Information" => ["primkey","record_id","lead_title","full_name","business_name","phone_number","alternative_phone_number","email_address","website_url"]
          ]
      ...
      "print_tables" => merge_setting(["leads"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["industry_type","lead_source","lead_status","lead_temperature","assigned_sales_rep","estimated_deal_value","expected_conversion_date","country_name","city_name","business_address","notes","next_follow_up_date","last_contact_date","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["notes"], "textarea_array"),
      ...
      "datetime_columns" => merge_setting(["expected_conversion_date","next_follow_up_date","last_contact_date","created_at","updated_at"], "datetime_columns"),

      "rename_cols_array" => merge_setting(
          ["assigned_sales_rep" => "Full Name"],
          "rename_cols_array"
      ),
      ...
      "new_label_buttons_arr" => merge_setting([
          "leads" => "plus-circle:New Leads:{`Leads / \${leadsNode?.full_name}`}"
    ...
    "import"=>[
        ...
        "leads"=>[
            ...
            "csv"=>"primkey,record_id,lead_title,full_name,business_name,phone_number,alternative_phone_number,email_address,website_url,industry_type,lead_source,lead_status,lead_temperature,assigned_sales_rep,estimated_deal_value,expected_conversion_date,country_name,city_name,business_address,notes,next_follow_up_date,last_contact_date,profile_photo,created_at,updated_at,hive_site_id,hive_site_name",
