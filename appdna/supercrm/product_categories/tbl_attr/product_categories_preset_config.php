...
//"primkey" , "record_id" , "category_name" , "category_description" , "parent_category_id" , "category_image" , "category_status" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="product_categories";
  $__page_title ="Product Categories";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"productcategories",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"productcategorieslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "product_categories" => ["primkey","record_id","category_name","category_description","parent_category_id","category_image","category_status","created_at","updated_at","hive_site_id","hive_site_name"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "product_categories" => [
                "Basic Information" => ["primkey","record_id","category_name","category_description","parent_category_id","category_image","category_status","created_at","updated_at"]
            ]
        ],

        "image_columns" => ["category_image"],
        "default_col_class" => "col-md-4",

        "hidden_inputs" => ["updated_at"],

        "print_tables" => ["product_categories"],
        ...
        "textarea_array" => ["category_description"],
        ...
        "new_label_buttons_arr" => [
            "product_categories" => "plus-circle:New Product Categories:{`Product Categories / \${product_categoriesNode?.category_description}`}"
        ],
    ...
    "import"=>[
        ...
        "product_categories"=>[
            ...
            "csv"=>"primkey,record_id,category_name,category_description,parent_category_id,category_image,category_status,created_at,updated_at,hive_site_id,hive_site_name",
