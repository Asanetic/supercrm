...
//"primkey" , "record_id" , "service_name" , "service_code" , "service_category_id" , "service_description" , "service_image" , "service_price" , "estimated_duration" , "billing_type" , "service_status" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="services";
  $__page_title ="Services";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"services",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"serviceslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "services" => ["primkey","record_id","service_name","service_code","service_category_id","service_description","service_image","service_price","estimated_duration","billing_type","service_status","created_at","updated_at","hive_site_id","hive_site_name"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "services" => [
                "Basic Information" => ["primkey","record_id","service_name","service_code","service_category_id","service_description","service_image","service_price","estimated_duration"]
            ]
        ],

        "image_columns" => ["service_image"],
        "default_col_class" => "col-md-4",

        "hidden_inputs" => ["updated_at"],

        "print_tables" => ["services"],
        ...
        "skip_cols_list" => ["billing_type","service_status","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "textarea_array" => ["service_description"],
		...
		"rename_cols_array" => ["service_category_id" => "Undefined"],
        ...
        "new_label_buttons_arr" => [
            "services" => "plus-circle:New Services:{`Services / \${servicesNode?.service_code}`}"
        ],
    ...
    "import"=>[
        ...
        "services"=>[
            ...
            "csv"=>"primkey,record_id,service_name,service_code,service_category_id,service_description,service_image,service_price,estimated_duration,billing_type,service_status,created_at,updated_at,hive_site_id,hive_site_name",
