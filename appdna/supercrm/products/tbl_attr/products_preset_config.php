...
//"primkey" , "record_id" , "product_name" , "product_code" , "product_category_id" , "product_description" , "product_image" , "unit_price" , "discount_price" , "tax_percentage" , "currency_code" , "stock_quantity" , "product_status" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "products" => ["primkey","record_id","product_name","product_code","product_category_id","product_description","product_image","unit_price","discount_price","tax_percentage","currency_code","stock_quantity","product_status","created_at","updated_at","hive_site_id","hive_site_name"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "products" => [
                "Basic Information" => ["primkey","record_id","product_name","product_code","product_category_id","product_description","product_image","unit_price","discount_price"]
            ]
        ],
        ...
        "skip_cols_list" => ["tax_percentage","currency_code","stock_quantity","product_status","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "textarea_array" => ["product_description"],
		...
		"rename_cols_array" => ["product_category_id" => "Undefined"],
        ...
        "new_label_buttons_arr" => [
            "products" => "plus-circle:New Products:{`Products / \${productsNode?.product_code}`}"
        ],
    ...
    "import"=>[
        ...
        "products"=>[
            ...
            "csv"=>"primkey,record_id,product_name,product_code,product_category_id,product_description,product_image,unit_price,discount_price,tax_percentage,currency_code,stock_quantity,product_status,created_at,updated_at,hive_site_id,hive_site_name",
