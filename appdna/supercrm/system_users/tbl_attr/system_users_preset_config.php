...
//"login_password" , "primkey" , "record_id" , "name" , "email" , "tel" , "ref_id" , "regdate" , "user_no" , "user_pic" , "user_gender" , "last_seen" , "about" , "hive_site_id" , "hive_site_name" , "auth_token" , "token_status" , "token_expiring_in" , "project_id" , "project_name" , "user_role" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  $core_module_configs_=[
    ...
    "table_alias" =>"systemusers",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"systemuserslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "system_users" => ["primkey","record_id","name","email","tel","login_password","ref_id","regdate","user_no","user_pic","user_gender","last_seen","about","hive_site_id","hive_site_name","auth_token","token_status","token_expiring_in","project_id","project_name","user_role"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "system_users" => [
              "Basic Information" => ["primkey","record_id","name","email","tel","login_password","ref_id","regdate","user_no"]
          ]
      ...
      "print_tables" => merge_setting(["system_users"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["user_pic","user_gender","last_seen","about","hive_site_id","hive_site_name","auth_token","token_status","token_expiring_in","project_id","project_name","user_role"], "skip_cols_list"),
      ...
      "password_columns" => merge_setting(["login_password"], "password_columns"),

      "title_columns" => merge_setting([], "title_columns"),

      "date_columns" => merge_setting([], "date_columns"),

      "datetime_columns" => merge_setting(["regdate"], "datetime_columns"),

      "rename_cols_array" => merge_setting(
          ["project_id" => "Page Url","record_id" => "User Name"],
          "rename_cols_array"
      ),
      ...
      "new_label_buttons_arr" => merge_setting([
          "system_users" => "plus-circle:New System Users:{`System Users / \${system_usersNode?.email}`}"
    ...
    "import"=>[
        ...
        "system_users"=>[
            ...
            "csv"=>"primkey,record_id,name,email,tel,login_password,ref_id,regdate,user_no,user_pic,user_gender,last_seen,about,hive_site_id,hive_site_name,auth_token,token_status,token_expiring_in,project_id,project_name,user_role",
