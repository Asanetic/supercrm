  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "skip_cols_list" => ["user_pic","user_gender","last_seen","about","hive_site_id","hive_site_name","auth_token","token_status","token_expiring_in","project_id","project_name","user_role"],
        ...
        "datetime_columns" => ["regdate"],

		"rename_cols_array" => ["project_id" => "Page Url","record_id" => "User Name"],
