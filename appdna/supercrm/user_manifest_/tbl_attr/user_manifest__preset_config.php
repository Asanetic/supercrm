...
//"primkey" , "admin_mkey" , "user_id" , "user_name" , "role_id" , "site_id" , "role_name" , "hive_site_id" , "hive_site_name" , "project_id" , "project_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="user_manifest_";
  $__page_title ="User Manifest ";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"usermanifest",     
    "primary_key"=>"primkey",
    "record_id"=>"admin_mkey",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"usermanifestlist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "user_manifest_" => ["primkey","admin_mkey","user_id","user_name","role_id","site_id","role_name","hive_site_id","hive_site_name","project_id","project_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "user_manifest_" => [
              "Basic Information" => ["primkey","admin_mkey","user_id","user_name","role_id","site_id","role_name","hive_site_id","hive_site_name"]
          ]
      ...
      "print_tables" => merge_setting(["user_manifest_"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["project_id","project_name","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "rename_tables_array" => merge_setting([
          "user_manifest_" => "User Manifest "
      ], "rename_tables_array"),

      "new_label_buttons_arr" => merge_setting([
          "user_manifest_" => "plus-circle:New User Manifest :{`User Manifest  / \${user_manifest_Node?.user_name}`}"
    ...
    "import"=>[
        ...
        "user_manifest_"=>[
            ...
            "csv"=>"primkey,admin_mkey,user_id,user_name,role_id,site_id,role_name,hive_site_id,hive_site_name,project_id,project_name",
