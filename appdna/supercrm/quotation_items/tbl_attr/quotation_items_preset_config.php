...
//"primkey" , "record_id" , "quotation_id" , "item_type" , "item_id" , "item_name" , "item_description" , "item_quantity" , "item_unit_price" , "item_total_amount" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="quotation_items";
  $__page_title ="Quotation Items";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"quotationitems",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"quotationitemslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "quotation_items" => ["primkey","record_id","quotation_id","item_type","item_id","item_name","item_description","item_quantity","item_unit_price","item_total_amount","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "quotation_items" => [
              "Basic Information" => ["primkey","record_id","quotation_id","item_type","item_id","item_name","item_description","item_quantity","item_unit_price"]
          ]
      ...
      "print_tables" => merge_setting(["quotation_items"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["item_total_amount","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "quotation_items" => "plus-circle:New Quotation Items:{`Quotation Items / \${quotation_itemsNode?.item_type}`}"
    ...
    "import"=>[
        ...
        "quotation_items"=>[
            ...
            "csv"=>"primkey,record_id,quotation_id,item_type,item_id,item_name,item_description,item_quantity,item_unit_price,item_total_amount,created_at,updated_at,hive_site_id,hive_site_name",
