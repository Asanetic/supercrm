  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "skip_cols_list" => merge_setting(["lead_source","country_name","city_name","client_status","assigned_sales_rep","business_address","tax_number","notes","last_contact_date","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
