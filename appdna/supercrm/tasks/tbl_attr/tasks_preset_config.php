  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "skip_cols_list" => ["deal_id","due_date","completed_on","task_notes","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "textarea_array" => ["task_description","task_notes"],
		...
		"rename_cols_array" => ["client_id" => "Full Name","deal_id" => "Deal Title","assigned_sales_rep" => "Full Name"],
