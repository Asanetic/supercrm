  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "skip_cols_list" => ["deal_id","client_id","payment_channel","payment_method","payment_status","currency_code","created_at","updated_at","hive_site_id","hive_site_name"],
		...
		"rename_cols_array" => ["invoice_id" => "Invoice Title","deal_id" => "Deal Title","client_id" => "Full Name"],
