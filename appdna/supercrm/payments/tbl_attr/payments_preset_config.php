...
//"primkey" , "record_id" , "paid_on" , "amount_paid" , "payment_for" , "payment_notes" , "transaction_ref" , "receipt_number" , "invoice_id" , "deal_id" , "client_id" , "payment_channel" , "payment_method" , "payment_status" , "currency_code" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "payments" => ["primkey","record_id","paid_on","amount_paid","payment_for","payment_notes","transaction_ref","receipt_number","invoice_id","deal_id","client_id","payment_channel","payment_method","payment_status","currency_code","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "payments" => [
              "Basic Information" => ["primkey","record_id","paid_on","amount_paid","payment_for","payment_notes","transaction_ref","receipt_number","invoice_id"]
          ]
      ...
      "print_tables" => merge_setting(["payments"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["deal_id","client_id","payment_channel","payment_method","payment_status","currency_code","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "textarea_array" => merge_setting(["payment_notes"], "textarea_array"),
      ...
      "rename_cols_array" => merge_setting(
          ["invoice_id" => "Invoice Title","deal_id" => "Deal Title","client_id" => "Full Name"],
          "rename_cols_array"
      ),
      ...
      "new_label_buttons_arr" => merge_setting([
          "payments" => "plus-circle:New Payments:{`Payments / \${paymentsNode?.amount_paid}`}"
    ...
    "import"=>[
        ...
        "payments"=>[
            ...
            "csv"=>"primkey,record_id,paid_on,amount_paid,payment_for,payment_notes,transaction_ref,receipt_number,invoice_id,deal_id,client_id,payment_channel,payment_method,payment_status,currency_code,created_at,updated_at,hive_site_id,hive_site_name",
