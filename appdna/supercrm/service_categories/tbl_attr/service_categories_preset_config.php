...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="service_categories";
  $__page_title ="Service Categories";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"servicecategories",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"servicecategorieslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "service_categories" => ["primkey","record_id","category_name","category_description","parent_category_id","category_image","category_status","created_at","updated_at","hive_site_id","hive_site_name"]
        ],
        ...
        "print_tables" => ["service_categories"],
        ...
        "new_label_buttons_arr" => [
            "service_categories" => "plus-circle:New Service Categories:{`Service Categories / \${service_categoriesNode?.category_description}`}"
        ],
