  ...
  */
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "skip_cols_list" => ["account_status","last_login","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "password_columns" => ["user_password"],
		...
		"rename_cols_array" => ["record_id" => "Task Title"],
