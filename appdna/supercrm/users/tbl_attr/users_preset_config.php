...
//"primkey" , "record_id" , "full_name" , "phone_number" , "email_address" , "user_password" , "user_role" , "department_name" , "profile_photo" , "account_status" , "last_login" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "users" => ["primkey","record_id","full_name","phone_number","email_address","user_password","user_role","department_name","profile_photo","account_status","last_login","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "users" => [
              "Basic Information" => ["primkey","record_id","full_name","phone_number","email_address","user_password","user_role","department_name","profile_photo"]
          ]
      ], "form_input_segmentation_arr"),

      "image_columns" => merge_setting(["profile_photo"], "image_columns"),

      "default_col_class" => "col-md-4",

      "hidden_inputs" => merge_setting(["updated_at"], "hidden_inputs"),

      "print_tables" => merge_setting(["users"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["account_status","last_login","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "password_columns" => merge_setting(["user_password"], "password_columns"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "users" => "plus-circle:New Users:{`Users / \${usersNode?.phone_number}`}"
    ...
    "import"=>[
        ...
        "users"=>[
            ...
            "csv"=>"primkey,record_id,full_name,phone_number,email_address,user_password,user_role,department_name,profile_photo,account_status,last_login,created_at,updated_at,hive_site_id,hive_site_name",
