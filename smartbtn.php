...
/* ====================================================== */
/* PRIMARY TABLE : product_categories */
/* BUTTON        : list : View Parent Category */
/* ====================================================== */


<MosyActionButton
    source="ProductCategoriesProfile"
    action="view_parent_category_profile_action_btn"
    label="View Parent Category"
    icon="list"

    onClick={()=>{

        viewProductCategories({childCol:`recordId`,parentColVal:product_categoriesNode.parent_category_id,parentName:product_categoriesNode.category_name})
...
/* ====================================================== */
/* PRIMARY TABLE : product_categories */
/* BUTTON        : list : View Products */
/* ====================================================== */


<MosyActionButton
    source="ProductCategoriesProfile"
    action="view_products_profile_action_btn"
    label="View Products"
    icon="list"

    onClick={()=>{

        viewProducts({childCol:`productCategoryId`,parentColVal:product_categoriesNode.record_id,parentName:product_categoriesNode.category_name})
...
/* BUTTON        : list : View Category Details */
/* ====================================================== */
...
/* ====================================================== */
/* PRIMARY TABLE : service_categories */
/* BUTTON        : list : View Parent Category */
/* ====================================================== */


<MosyActionButton
    source="ServiceCategoriesProfile"
    action="view_parent_category_profile_action_btn"
    label="View Parent Category"
    icon="list"
    ...
    onClick={()=>{
        ...
        viewServiceCategories({childCol:`recordId`,parentColVal:service_categoriesNode.parent_category_id,parentName:service_categoriesNode.category_name})
...
/* ====================================================== */
/* PRIMARY TABLE : service_categories */
/* BUTTON        : list : View Services */
/* ====================================================== */


<MosyActionButton
    source="ServiceCategoriesProfile"
    action="view_services_profile_action_btn"
    label="View Services"
    icon="list"

    onClick={()=>{

        viewServices({childCol:`serviceCategoryId`,parentColVal:service_categoriesNode.record_id,parentName:service_categoriesNode.category_name})
...
/* ====================================================== */
/* PRIMARY TABLE : clients */
/* BUTTON        : user-x: Inactive Clients */
/* ====================================================== */
...
/* ====================================================== */
/* PRIMARY TABLE : deals */
/* BUTTON        : file-plus: Create Quotation */
/* ====================================================== */
...
/* ====================================================== */
/* PRIMARY TABLE : leads */
/* BUTTON        : badge-check: Qualified Leads */
/* ====================================================== */
...
/* ====================================================== */
/* PRIMARY TABLE : payments */
/* BUTTON        : rotate-ccw: Refund Payment */
/* ====================================================== */
...
/* ====================================================== */
/* PRIMARY TABLE : payments */
/* BUTTON        : badge-check: Successful Payments */
/* ====================================================== */
...
/* ====================================================== */
/* PRIMARY TABLE : products */
/* BUTTON        : alert-triangle: Out Of Stock Products */
/* ====================================================== */
...
/* ====================================================== */
/* PRIMARY TABLE : services */
/* BUTTON        : refresh-cw: Recurring Services */
/* ====================================================== */
...
/* ====================================================== */
/* PRIMARY TABLE : services */
/* BUTTON        : credit-card: One Time Services */
/* ====================================================== */
...
<MosyActionButton
    ...
    onClick={()=>{
        ...
        viewExpectedRevenue({childCol:`dealId`,parentColVal:expected_revenueNode.record_id,parentName:expected_revenueNode.revenue_title})
...
<MosyActionButton
    source="ExpectedRevenueProfile"
    action="filter_by_client_profile_action_btn"
    label="Filter By Client"
    icon="building"

    onClick={()=>{

        filterRevenueByClient('client_id')
...
<MosyActionButton
    source="ExpectedRevenueProfile"
    action="filter_by_deal_profile_action_btn"
    label="Filter By Deal"
    icon="briefcase"

    onClick={()=>{

        filterRevenueByDeal('deal_id')
...
/* ====================================================== */
/* PRIMARY TABLE : expected_revenue */
/* BUTTON        : layers: Filter By Status */
/* ====================================================== */


<MosyActionButton
    source="ExpectedRevenueProfile"
    action="filter_by_status_profile_action_btn"
    label="Filter By Status"
    icon="layers"

    onClick={()=>{

        filterRevenueByStatus('revenue_status')
...
/* ====================================================== */
/* PRIMARY TABLE : expected_revenue */
/* BUTTON        : git-branch: Filter By Source Type */
/* ====================================================== */


<MosyActionButton
    source="ExpectedRevenueProfile"
    action="filter_by_source_type_profile_action_btn"
    label="Filter By Source Type"
    icon="git-branch"

    onClick={()=>{

        filterRevenueBySourceType('revenue_source_type')
...
<MosyActionButton
    ...
    onClick={()=>{
        ...
        filterRevenueByClient({
            ...
            title : "clients:full_name|record_id:client_id",
            customQueryStr : customQueryStr,
            stateItemSetters : stateItemSetters,
            parentColName : "",
            childColName : "",
...
<MosyActionButton
    ...
    onClick={()=>{
        ...
        filterRevenueByStatus({
            ...
            colName: "filter by status",

            colVal: "revenue_status",
