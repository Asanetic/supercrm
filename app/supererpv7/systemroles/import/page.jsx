...
export async function generateMetadata({ searchParams }) {
  const mosyTitle = 'Import Systemroles data ';
          ...
          <div className='page-wrapper'>
             <div className='content container-fluid p-0 m-0'>
              <div className='p-3'>
               ...
               <ImportCSVComponent colsArray={colsArray} title='Import Systemroles data ' endpoint={apiRoutes.systemroles.import} templateName='import_system_users_data__template.csv'/>
              </Suspense>
            </div>
             </div>
           </div>
