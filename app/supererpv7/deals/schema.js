...
export const DealsSchema = {
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/supererpv7/deals/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Deal', icon: 'plus', variant: 'outline-primary', navigateTo: '/supererpv7/deals/profile', grid: true, form: false, rowAction: false },
