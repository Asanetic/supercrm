...
export const ProductsSchema = {
  ...
  showInList: ['row_count', 'product_name', 'price_range', 'unit_price', 'product_code', 'category', 'product_description', 'product_image'],
  ...
  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['product_name', 'price_range', 'unit_price', 'product_code', 'category', 'product_description', 'product_image'] },
  ...
  fields: [
    ...
    { key: 'category', label: 'Category', type: 'groupedSelect', endpoint: '/api/supererpv7/products', groupByField: 'category' },
    { key: 'product_description', label: 'Product Description', type: 'textarea', colSpan: 3 },
