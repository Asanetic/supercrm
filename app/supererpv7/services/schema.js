...
const moduleApi = apiRoutes.services.base;

export const ServicesSchema = {
  entity: 'services',              // DB table name; also drives default role names
                                     // (view_services / manage_services) and apiBase
  label: 'Services',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.services.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/supererpv7/services/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this service?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_services' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Service', icon: 'plus', variant: 'outline-primary', navigateTo: '/supererpv7/services/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_services' },
  ...
  showInList: ['row_count', 'service_code', 'service_name', 'category', 'price_range', 'service_price', 'service_description', 'billing_type'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['service_code', 'service_name', 'category', 'price_range', 'service_price', 'service_description', 'billing_type'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['service_code', 'service_name', 'category', 'price_range', 'service_price', 'service_description', 'billing_type'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['service_status'] },
  ],
  ...
  fields: [
    ...
    { key: 'service_code', label: 'Service Code', type: 'text', title: true },
    { key: 'service_name', label: 'Service Name', type: 'text', title: true },
    { key: 'category', label: 'Category', type: 'groupedSelect', endpoint: '/api/supererpv7/services', groupByField: 'category' },
    { key: 'price_range', label: 'Price Range', type: 'text' },
    { key: 'service_price', label: 'Service Price', type: 'money' },
    { key: 'service_description', label: 'Service Description', type: 'textarea', colSpan: 3 },
    { key: 'billing_type', label: 'Billing Type', type: 'text' },
