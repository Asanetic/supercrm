...
export const ActivitiesSchema = {
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/supererpv7/activities/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Activitie', icon: 'plus', variant: 'outline-primary', navigateTo: '/supererpv7/activities/profile', grid: true, form: false, rowAction: false },
  ...
  showInList: ['row_count', 'client_id', 'deal_id', 'activity_type', 'activity_title', 'activity_description', 'activity_status', 'performed_by'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['client_id', 'deal_id', 'activity_type', 'activity_title', 'activity_description', 'activity_status', 'performed_by'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['client_id', 'deal_id', 'activity_type', 'activity_title', 'activity_description', 'activity_status', 'performed_by'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['activity_date', 'next_action_date'] },
  ],
  ...
  fields: [
    ...
    { key: 'activity_title', label: 'Activity Title', type: 'text' },
    { key: 'activity_description', label: 'Activity Description', type: 'textarea', colSpan: 3 },
