...
const moduleApi =  '/api/assetguard/systemmodules';

export const SystemmodulesSchema = {
  entity: 'system_modules',              // DB table name; also drives default role names
                                     // (view_systemmodules / manage_systemmodules) and apiBase
  label: 'Modules',                 // optional, defaults to entity capitalized
  apiBase:moduleApi,
  ...
  moduleRole: 'view_systemmodules',

  // Field keys shown as columns in list view, in display order.
  showInList: ['row_count', 'module_name', 'module_key', 'module_group', 'module_type', 'module_status'],
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/assetguard/systemmodules/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this systemmodule?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_systemmodules' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'add_new_module', label: 'Add module', type: 'action', icon: 'plus-circle', variant:"primary",grid: true, form: false, rowAction: false },
    { key: 'new', label: 'Add Module', icon: 'plus', variant: 'outline-primary', navigateTo: '/assetguard/systemmodules/profile', grid: false, form: false, rowAction: false },
    { key: 'clone', label: 'Clone & Edit', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_systemmodules' },
    { key: 'view_roles', label: 'View Roles', icon: 'copy', navigateTo: '/assetguard/systemroles/list', grid: true, form: false, rowAction: false },
  ...
  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['module_name', 'module_key', 'module_group', 'module_type', 'module_status','date_created'] },
  ],
  ...
  fields: [
    ...
    { key: 'module_name', label: 'Module Name', type: 'text', title: true, required: true, searchable: true },
    { key: 'module_key', label: 'Key', computed: true, type: 'text', title: true , editable: false},
    { key: 'module_group', label: 'Group', type: 'groupedSelect', endpoint:`${moduleApi}` },
    { key: 'module_type', label: 'Type', type: 'select',  options: ['Page', 'Button', 'Datapoint'] },
    { key: 'module_status', label: 'Status', type: 'select', options: ['active', 'inactive'], searchable: true },
    { key: 'date_created', label: 'Date Created', type: 'datetime', editable:false },
  ...
  // roles: { view: 'view_systemmodules', manage: 'manage_systemmodules' },
};
