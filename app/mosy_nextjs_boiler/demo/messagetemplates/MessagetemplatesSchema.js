...
const moduleApi = apiRoutes.messagetemplates.base;

export const MessagetemplatesSchema = {
  entity: 'smart_message_templates',              // DB table name; also drives default role names
                                     // (view_messagetemplates / manage_messagetemplates) and apiBase
  label: 'Messagetemplates',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.messagetemplates.import,
  ...
  moduleRole: 'view_messagetemplates',
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/imsv2/messagetemplates/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this messagetemplate?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_messagetemplates' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Messagetemplate', icon: 'plus', variant: 'outline-primary', navigateTo: '/imsv2/messagetemplates/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_messagetemplates' },
