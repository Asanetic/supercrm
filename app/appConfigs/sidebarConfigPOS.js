...
export const sidebarConfig = [
...

  {
    ...
    items: [
      ...
      { label: "Product Categories", href: (routes) => `${routes.cms}/productcategories/list`, roles: [] },
      { label: "New Category", href: (routes) => `${routes.cms}/productcategories/profile`, roles: [] },
    ],
  },

  {
    ...
    items: [
      ...
      { label: "Service Categories", href: (routes) => `${routes.cms}/servicecategories/list`, roles: [] },
      { label: "New Category", href: (routes) => `${routes.cms}/servicecategories/profile`, roles: [] },
    ],
  },
...

  {
    ...
    items: [
      ...
      { label: "Communication Logs", href: (routes) => `${routes.cms}/activities/list`, roles: [] },
    ],
  },
