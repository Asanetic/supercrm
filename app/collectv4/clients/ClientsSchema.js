...
export const ClientsSchema = {
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/collectv4/clients/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Client', icon: 'plus', variant: 'outline-primary', navigateTo: '/collectv4/clients/profile', grid: true, form: false, rowAction: false },
