...
const moduleApi = apiRoutes.payments.base;
...
export const PaymentsSchema = {
  ...
  importDataEndpoint : apiRoutes.payments.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/novaerpv9/payments/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this payment?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_payments' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Payment', icon: 'plus', variant: 'outline-primary', navigateTo: '/novaerpv9/payments/profile', grid: true, form: false, rowAction: false },
    ...
    { key: 'send_message', label: 'Send Acknowledgment', icon: 'envelope', variant: 'outline-info', colorClass: 'dyn-btn-accent-blue', type: 'action', editOnly: true, grid: false, form: true, rowAction: true },
  ],
  ...
  showInList: ['row_count', 'paid_on', 'amount_paid', 'payment_for', 'payment_notes', 'transaction_ref', 'receipt_number', 'invoice_id'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['paid_on', 'amount_paid', 'payment_for', 'payment_notes', 'transaction_ref', 'receipt_number', 'invoice_id'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['paid_on', 'amount_paid', 'payment_for', 'payment_notes', 'transaction_ref', 'receipt_number', 'invoice_id'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['deal_id', 'client_id', 'payment_channel', 'payment_method', 'payment_status', 'currency_code'] },
  ],
