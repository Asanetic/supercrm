...
export const LeadsSchema = {
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/novaerpv9/leads/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Lead', icon: 'plus', variant: 'outline-primary', navigateTo: '/novaerpv9/leads/profile', grid: true, form: false, rowAction: false },
    ...
    { key: 'convert_to_client', label: 'Convert to Client', icon: 'user-plus', variant: 'outline-primary', colorClass: 'dyn-btn-accent-green', type: 'action', confirm: 'Convert this lead to a client?', editOnly: true, grid: false, form: true, rowAction: true },
    { key: 'add_quotation', label: 'Add Quotation', icon: 'file-text-o', variant: 'outline-secondary', colorClass: 'dyn-btn-accent-amber', type: 'action', editOnly: true, grid: false, form: true, rowAction: true },
    ...
    { key: 'message_history', label: 'Message History', icon: 'envelope-o', variant: 'outline-secondary', colorClass: 'dyn-btn-accent-blue', type: 'action', editOnly: true, grid: false, form: true, rowAction: false },
    { key: 'call_history', label: 'Call History', icon: 'history', variant: 'outline-secondary', colorClass: 'dyn-btn-accent-purple', type: 'action', editOnly: true, grid: false, form: true, rowAction: false },
  ],
