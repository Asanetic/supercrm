...
const moduleApi = apiRoutes.phonebook.base;

export const PhonebookSchema = {
  entity: 'phone_book',              // DB table name; also drives default role names
                                     // (view_phonebook / manage_phonebook) and apiBase
  label: 'Phonebook',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.phonebook.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/novaerpv9/phonebook/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this phonebook?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_phonebook' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Phonebook', icon: 'plus', variant: 'outline-primary', navigateTo: '/novaerpv9/phonebook/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_phonebook' },
  ...
  showInList: ['row_count', 'name', 'phone', 'email', 'category', 'notes', 'created_on'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['name', 'phone', 'email', 'category', 'notes', 'created_on'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 4, fields: ['name', 'phone', 'email', 'category', 'notes', 'created_on'] },
  ],
  ...
  fields: [
    ...
    { key: 'name', label: 'Name', type: 'text', title: true, required: true },
...
// dyn-btn-accent-teal   { border-color: transparent; color: #0f766e; }
  ...
  // roles: { view: 'view_phonebook', manage: 'manage_phonebook' },
};
