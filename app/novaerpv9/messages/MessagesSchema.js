...
export const MessagesSchema = {
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/novaerpv9/messages/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Message', icon: 'plus', variant: 'outline-primary', navigateTo: '/novaerpv9/messages/profile', grid: true, form: false, rowAction: false },
    ...
    { key: 'resend_message', label: 'Resend', icon: 'refresh', variant: 'outline-info', colorClass: 'dyn-btn-accent-blue', type: 'action', editOnly: true, grid: false, form: true, rowAction: true },
    { key: 'forward_message', label: 'Forward', icon: 'share', variant: 'outline-secondary', colorClass: 'dyn-btn-accent-purple', type: 'action', editOnly: true, grid: false, form: true, rowAction: true },
  ],
