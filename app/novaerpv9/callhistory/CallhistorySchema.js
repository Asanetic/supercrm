...
const moduleApi = apiRoutes.callhistory.base;

export const CallhistorySchema = {
  entity: 'smart_calls',              // DB table name; also drives default role names
                                     // (view_callhistory / manage_callhistory) and apiBase
  label: 'Callhistory',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.callhistory.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/novaerpv9/callhistory/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this callhistory?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_callhistory' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Callhistory', icon: 'plus', variant: 'outline-primary', navigateTo: '/novaerpv9/callhistory/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_callhistory' },
    ...
    { key: 'view_history', label: 'View History', icon: 'history', variant: 'outline-secondary', colorClass: 'dyn-btn-accent-purple', type: 'action', editOnly: true, grid: false, form: true, rowAction: true },
  ],
...
// dyn-btn-accent-teal   { border-color: transparent; color: #0f766e; }
  ...
  // roles: { view: 'view_callhistory', manage: 'manage_callhistory' },
};
