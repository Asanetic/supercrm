...
const moduleApi = apiRoutes.quicknotes.base;

export const QuicknotesSchema = {
  entity: 'quick_notes',              // DB table name; also drives default role names
                                     // (view_quicknotes / manage_quicknotes) and apiBase
  label: 'Quick notes',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.quicknotes.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/novaerpv9/quicknotes/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this quicknote?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_quicknotes' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New note', icon: 'plus', variant: 'outline-primary', navigateTo: '/novaerpv9/quicknotes/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_quicknotes' },
    ...
    { key: 'export_pdf', label: 'Export to PDF', icon: 'file-pdf-o', colorClass: 'dyn-btn-accent-teal', type: 'action', editOnly: true, grid: false, form: true, rowAction: true },
    { key: 'export_docx', label: 'Export to DOCX', icon: 'file-word-o', variant: 'outline-primary', colorClass: 'dyn-btn-accent-blue', type: 'action', editOnly: true, grid: false, form: true, rowAction: true },
  ],
  ...
  showInList: ['row_count', 'note_title', 'note_date', 'note_details', 'note_tag'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['note_title', 'note_date', 'note_details', 'note_tag'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['note_title', 'note_tag', 'note_details', 'note_date'] },
  ],
  ...
  fields: [
    ...
    { key: 'note_title', label: 'Note Title', type: 'text', title:true , colSpan :6},
    { key: 'note_tag', label: 'Note Tag', type: 'groupedSelect' , colSpan :6, endpoint: moduleApi},
    { key: 'note_date', label: 'Note Date', type: 'datetime', editOnly: true },
    { key: 'note_details', label: 'Note Details', type: 'richtext', colSpan :12 , trim:30},
...
// dyn-btn-accent-teal   { border-color: transparent; color: #0f766e; }
  ...
  // roles: { view: 'view_quicknotes', manage: 'manage_quicknotes' },
};
