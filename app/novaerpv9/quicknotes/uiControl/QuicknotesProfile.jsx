...
// QuicknotesProfile — pure shell. It resolves the id, wires up the
...
export default function QuicknotesProfile({ id: idProp, onDone, hiddenActions = [], presetValues, schemaOverride }) {
  const searchParams = useSearchParams();
  const schema = schemaOverride || QuicknotesSchema;
  const id = idProp ?? searchParams.get(`${QuicknotesSchema.entity}_dataNode`);
  const form = useEntityFormController(schema, QuicknotesActions, {
    id,
    onDone,
