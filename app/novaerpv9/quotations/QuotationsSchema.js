...
const moduleApi = apiRoutes.quotations.base;

export const QuotationsSchema = {
  entity: 'quotations',              // DB table name; also drives default role names
                                     // (view_quotations / manage_quotations) and apiBase
  label: 'Quotations',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.quotations.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/novaerpv9/quotations/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this quotation?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_quotations' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Quotation', icon: 'plus', variant: 'outline-primary', navigateTo: '/novaerpv9/quotations/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_quotations' },
  ...
  showInList: ['row_count', 'quotation_number', 'quotation_title', 'quotation_description', 'client_id', 'deal_id', 'quotation_amount', 'tax_amount'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['quotation_number', 'quotation_title', 'quotation_description', 'client_id', 'deal_id', 'quotation_amount', 'tax_amount'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['quotation_number', 'quotation_title', 'quotation_description', 'client_id', 'deal_id', 'quotation_amount', 'tax_amount'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['discount_amount', 'quotation_status', 'quotation_issued_on', 'quotation_expiry_date', 'quotation_notes'] },
  ],
  ...
  fields: [
    ...
    { key: 'quotation_title', label: 'Quotation Title', type: 'text' },
    { key: 'quotation_description', label: 'Quotation Description', type: 'textarea', colSpan: 3 },
    { key: 'client_id', label: 'Client Id', type: 'text' },
    { key: 'deal_id', label: 'Deal Id', type: 'text' },
    { key: 'quotation_amount', label: 'Quotation Amount', type: 'money' },
    { key: 'tax_amount', label: 'Tax Amount', type: 'money' },
    { key: 'discount_amount', label: 'Discount Amount', type: 'money' },
    { key: 'quotation_status', label: 'Quotation Status', type: 'text' },
    { key: 'quotation_issued_on', label: 'Quotation Issued On', type: 'datetime' },
    { key: 'quotation_expiry_date', label: 'Quotation Expiry Date', type: 'datetime' },
    { key: 'quotation_notes', label: 'Quotation Notes', type: 'textarea', colSpan: 3 },
...
// dyn-btn-accent-teal   { border-color: transparent; color: #0f766e; }
  ...
  // roles: { view: 'view_quotations', manage: 'manage_quotations' },
};
