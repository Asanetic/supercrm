...
export const DealsSchema = {
  ...
  profileActions: [
    ...
    { key: 'new', label: 'New Deal', icon: 'plus', variant: 'outline-primary', navigateTo: '/novaerpv9/deals/profile', grid: true, form: false, rowAction: false },
  ...
  fields: [
    ...
    { key: 'deal_value', label: 'Deal Value', type: 'money' },
