...
const moduleApi = apiRoutes.smartpaymentrequests.base;

export const SmartpaymentrequestsSchema = {
  entity: 'smart_payment_requests',              // DB table name; also drives default role names
                                     // (view_smartpaymentrequests / manage_smartpaymentrequests) and apiBase
  label: 'Smartpaymentrequests',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.smartpaymentrequests.import,
  ...
  moduleRole: 'view_smartpaymentrequests',
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/novaerpv9/smartpaymentrequests/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this smartpaymentrequest?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_smartpaymentrequests' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Smartpaymentrequest', icon: 'plus', variant: 'outline-primary', navigateTo: '/novaerpv9/smartpaymentrequests/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_smartpaymentrequests' },
...
// dyn-btn-accent-teal   { border-color: transparent; color: #0f766e; }
  ...
  // roles: { view: 'view_smartpaymentrequests', manage: 'manage_smartpaymentrequests' },
};
