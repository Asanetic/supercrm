...
// SmartpaymentrequestsProfile — pure shell. It resolves the id, wires up the
...
export default function SmartpaymentrequestsProfile({ id: idProp, onDone, hiddenActions = [], presetValues, schemaOverride }) {
  const searchParams = useSearchParams();
  const schema = schemaOverride || SmartpaymentrequestsSchema;
  const id = idProp ?? searchParams.get(`${SmartpaymentrequestsSchema.entity}_dataNode`);
  const form = useEntityFormController(schema, SmartpaymentrequestsActions, {
    id,
    onDone,
