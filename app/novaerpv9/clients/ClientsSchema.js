...
const moduleApi = apiRoutes.clients.base;

export const ClientsSchema = {
  entity: 'clients',              // DB table name; also drives default role names
                                     // (view_clients / manage_clients) and apiBase
  label: 'Clients',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.clients.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/novaerpv9/clients/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this client?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_clients' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Client', icon: 'plus', variant: 'outline-primary', navigateTo: '/novaerpv9/clients/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_clients' },
    ...
    { key: 'request_payment', label: 'Request Payment', icon: 'money', variant: 'outline-primary', colorClass: 'dyn-btn-accent-teal', type: 'action', editOnly: true, grid: false, form: true, rowAction: true },
    { key: 'view_deals', label: 'View Deals', icon: 'handshake-o', variant: 'outline-secondary', colorClass: 'dyn-btn-accent-purple', type: 'action', editOnly: true, grid: false, form: true, rowAction: true },
    { key: 'add_deal', label: 'Add Deal', icon: 'plus-circle', variant: 'outline-secondary', colorClass: 'dyn-btn-accent-amber', type: 'action', editOnly: true, grid: false, form: true, rowAction: true },
  ...
  showInList: ['row_count', 'full_name', 'business_name', 'phone_number', 'alternative_phone_number', 'email_address', 'website_url', 'industry_type'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['full_name', 'business_name', 'phone_number', 'alternative_phone_number', 'email_address', 'website_url', 'industry_type'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['full_name', 'business_name', 'phone_number', 'alternative_phone_number', 'email_address', 'website_url', 'industry_type'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['lead_source', 'country_name', 'city_name', 'client_status', 'converted_lead_id', 'assigned_sales_rep', 'business_address', 'tax_number', 'profile_photo', 'notes', 'last_contact_date'] },
  ],
  ...
  fields: [
    ...
    { key: 'converted_lead_id', label: 'Converted Lead Id', type: 'text' },
