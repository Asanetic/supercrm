...
// usersledger (table, card grid, kanban, whatever) calls this and gets back
...
//
// Usersledgers should contain markup only — no business logic. If a new
// usersledger needs a capability this hook doesn't expose yet, add it HERE,
// not in the usersledger, so every usersledger gets it for free.
//
// Usage:
