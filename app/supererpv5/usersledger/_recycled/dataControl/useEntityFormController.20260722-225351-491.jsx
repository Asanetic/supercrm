...
// Mirrors useEntityGridController: any UI usersledger (DynamicForm, a modal,
...
// from schema.profileActions. The usersledger never hardcodes a single
...
//   ))}
//
// Swap schema.profileActions and the SAME usersledger renders a totally
// different button set — no usersledger edits needed.
