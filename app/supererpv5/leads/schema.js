...
const moduleApi =  '/api/supererpv5/leads';

export const LeadsSchema = {
  entity: 'crm_leads',              // DB table name; also drives default role names
  ...
  importDataEndpoint : '/api/supererpv5/leads/import',
  ...
  showInList: ['row_count', 'lead_name', 'contact_id', 'company_id', 'lead_source', 'lead_status', 'interest_level', 'estimated_value'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['row_count', 'lead_name', 'contact_id', 'company_id', 'lead_source', 'lead_status', 'interest_level', 'estimated_value'],
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/supererpv5/leads/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Lead', icon: 'plus', variant: 'outline-primary', navigateTo: '/supererpv5/leads/profile', grid: true, form: false, rowAction: false },
  ...
  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['lead_name', 'contact_id', 'company_id', 'lead_source', 'lead_status', 'interest_level', 'estimated_value'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['assigned_user_id', 'next_followup_date', 'notes', 'converted_status', 'converted_contact_id', 'converted_deal_id', 'created_by', 'date_created', 'date_updated', 'hive_site_id', 'hive_site_name'] },
  ],
