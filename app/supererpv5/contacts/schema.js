...
const moduleApi =  '/api/supererpv5/contacts';

export const ContactsSchema = {
  entity: 'crm_contacts',              // DB table name; also drives default role names
                                     // (view_contacts / manage_contacts) and apiBase
  label: 'Contacts',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : '/api/supererpv5/contacts/import',
  ...
  showInList: ['row_count', 'contact_name', 'company_name', 'email', 'phone', 'date_created'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['row_count', 'contact_name', 'first_name', 'last_name', 'email', 'phone', 'alt_phone', 'company_id'],
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/supererpv5/contacts/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this contact?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_contacts' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Contact', icon: 'plus', variant: 'outline-primary', navigateTo: '/supererpv5/contacts/profile', grid: true, form: false, rowAction: false },
    //{ key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_contacts' },
  ...
  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['profile_photo','contact_name', 'first_name', 'last_name', 'email', 'phone', 'alt_phone', 'company_id'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['job_title', 'lead_source', 'contact_status', 'country', 'city', 'address', 'notes', 'assigned_user_id', 'created_by', 'date_created', 'date_updated', 'hive_site_id', 'hive_site_name', 'lead_id'] },
  ],
  ...
  fields: [
    ...
    { key: 'profile_photo', label: 'Profile Photo', type: 'image', imageClass:"useravatar_120", colSpan:12 },
    { key: 'notes', label: 'Notes', type: 'textarea', colSpan: 6, searchable: true },
    ...
    { key: 'company_id', label: 'Company',
      ...
      endpoint: '/api/supererpv5/companies',
