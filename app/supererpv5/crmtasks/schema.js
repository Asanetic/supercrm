...
const moduleApi = apiRoutes.crmtasks.base;

export const CrmtasksSchema = {
  entity: 'crm_tasks',              // DB table name; also drives default role names
                                     // (view_crmtasks / manage_crmtasks) and apiBase
  label: 'Crmtasks',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.crmtasks.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/supererpv5/crmtasks/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this crmtask?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_crmtasks' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Crmtask', icon: 'plus', variant: 'outline-primary', navigateTo: '/supererpv5/crmtasks/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_crmtasks' },
