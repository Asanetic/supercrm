...
export async function generateMetadata({ searchParams }) {
  const mosyTitle = 'Import Systemmodules data ';
          ...
          <div className='page-wrapper'>
             <div className='content container-fluid p-0 m-0'>
              <div className='p-3'>
               ...
               <ImportCSVComponent colsArray={colsArray} title='Import Systemmodules data ' endpoint={apiRoutes.systemmodules.import} templateName='import_system_users_data__template.csv'/>
              </Suspense>
            </div>
             </div>
           </div>
