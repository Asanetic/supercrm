...
const SystemmodulesActions = {
  ...
  add_new_module: async ({ schema, create, refresh }) => {
    MosyCard("", <SystemmodulesProfile onDone={refresh} hiddenActions={['back']}/>, false, "modal2","mosycard_medium");
  },
...
export default SystemmodulesActions
