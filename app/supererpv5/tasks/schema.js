...
export const TasksSchema = {
  ...
  profileActions: [
    ...
    { key: 'filter_by_month', label: 'Filter by month', icon: 'calendar',  colorClass:"dyn-btn-accent-teal ", grid:true, type: 'action', form: true, rowAction: false },
    { key: 'filter_by_status', label: 'Filter by status', icon: 'bolt', colorClass:"dyn-btn-accent-blue", grid:true, type: 'action', form: true, rowAction: false },
    { key: 'mark_paid', label: 'Update status', colorClass:"dyn-btn-accent-purple", icon: 'info-circle', grid:true, type: 'action', form: true, rowAction: true },
    { key: 'filter_by_client', label: 'Filter by account', icon: 'user', grid:true, type: 'action', form: true, rowAction: false },
  ...
  fields: [
    ...
    { key: 'task_title', label: 'Task Title', type: 'text', title:true },
