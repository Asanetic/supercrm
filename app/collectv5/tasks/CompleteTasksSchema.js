...
const moduleApi = apiRoutes.completetasks.base;

export const CompleteTasksSchema = {
  entity: 'tasks',              // DB table name; also drives default role names
  ...
  importDataEndpoint : apiRoutes.completetasks.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/collectv5/tasks/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Task', icon: 'plus', variant: 'outline-primary', navigateTo: '/collectv5/tasks/profile', grid: true, form: false, rowAction: false },
  ...
  showInList: ['row_count', 'task_title', 'task_description', 'task_type', 'task_priority', 'task_status', 'client_id', 'lead_id'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['task_title', 'task_description', 'task_type', 'task_priority', 'task_status', 'client_id', 'lead_id'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['task_title', 'task_description', 'task_type', 'task_priority', 'task_status', 'client_id', 'lead_id'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['deal_id', 'due_date', 'completed_on', 'task_notes', 'assigned_sales_rep'] },
  ],
  ...
  fields: [
    ...
    { key: 'task_priority', label: 'Task Priority', type: 'text' },
    ...
    { key: 'task_notes', label: 'Task Notes', type: 'textarea', colSpan: 3 },
