...
const moduleApi = apiRoutes.activeusers.base;

export const ActiveUsersSchema = {
  entity: 'users',              // DB table name; also drives default role names
                                     // (view_users / manage_users) and apiBase
  label: 'Users',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.activeusers.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/collectv5/users/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this user?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_users' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New User', icon: 'plus', variant: 'outline-primary', navigateTo: '/collectv5/users/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_users' },
  ...
  showInList: ['row_count', 'full_name', 'phone_number', 'email_address', 'user_role', 'department_name', 'profile_photo', 'account_status'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['full_name', 'phone_number', 'email_address', 'user_role', 'department_name', 'profile_photo', 'account_status'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['full_name', 'phone_number', 'email_address', 'user_role', 'department_name', 'profile_photo', 'account_status'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['last_login'] },
  ],
  ...
  fields: [
    ...
    { key: 'department_name', label: 'Department Name', type: 'text', title: true },
...
// dyn-btn-accent-teal   { border-color: transparent; color: #0f766e; }
  ...
  // roles: { view: 'view_users', manage: 'manage_users' },
};
