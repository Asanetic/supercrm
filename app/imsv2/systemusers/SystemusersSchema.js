...
export const SystemusersSchema = {
  ...
  importDataEndpoint : apiRoutes.systemusers.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/imsv2/systemusers/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Systemuser', icon: 'plus', variant: 'outline-primary', navigateTo: '/imsv2/systemusers/profile', grid: true, form: false, rowAction: false },
  ...
  fields: [
    ...
    { key: 'user_pic', label: 'User Pic', type: 'text' },
