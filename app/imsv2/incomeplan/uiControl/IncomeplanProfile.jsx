...
// IncomeplanProfile — pure shell. It resolves the id, wires up the
...
export default function IncomeplanProfile({ id: idProp, onDone, hiddenActions = [], presetValues, schemaOverride }) {
  const searchParams = useSearchParams();
  const schema = schemaOverride || IncomeplanSchema;
  const id = idProp ?? searchParams.get(`${IncomeplanSchema.entity}_dataNode`);
  const form = useEntityFormController(schema, IncomeplanActions, {
    id,
    onDone,
