...
const moduleApi = apiRoutes.mosyreminderlogs.base;

export const MosyreminderlogsSchema = {
  entity: 'mosy_reminder_log',              // DB table name; also drives default role names
                                     // (view_mosyreminderlogs / manage_mosyreminderlogs) and apiBase
  label: 'Reminder logs',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.mosyreminderlogs.import,
  ...
  moduleRole: 'view_mosyreminderlogs',
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/imsv2/mosyreminderlogs/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this mosyreminderlog?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_mosyreminderlogs' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Mosyreminderlog', icon: 'plus', variant: 'outline-primary', navigateTo: '/imsv2/mosyreminderlogs/profile', grid: false, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_mosyreminderlogs' },
  ...
  showInList: ['row_count', 'reminder_id', 'tenant_id', 'channel', 'recipient', 'rendered_message', 'status', 'error_message'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['reminder_id', 'tenant_id', 'channel', 'recipient', 'rendered_message', 'status', 'error_message'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['reminder_id', 'tenant_id', 'channel', 'recipient', 'rendered_message', 'status', 'error_message'] },
  ...
  fields: [
    ...
    { key: 'log_id', label: 'Log Id', type: 'text', system: true, editable: false },
    { key: 'reminder_id', label: 'Reminder Id', type: 'text' },
    { key: 'tenant_id', label: 'Tenant Id', type: 'text' },
    { key: 'channel', label: 'Channel', type: 'text' },
    { key: 'recipient', label: 'Recipient', type: 'text' },
    { key: 'rendered_message', label: 'Rendered Message', type: 'textarea', colSpan: 3 },
    { key: 'status', label: 'Status', type: 'groupedSelect', endpoint: moduleApi, groupByField: 'status' },
    { key: 'error_message', label: 'Error Message', type: 'textarea', colSpan: 3 },
