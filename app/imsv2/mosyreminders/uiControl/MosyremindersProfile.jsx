...
// MosyremindersProfile — pure shell. It resolves the id, wires up the
...
export default function MosyremindersProfile({ id: idProp, onDone, hiddenActions = [], presetValues, schemaOverride }) {
  const searchParams = useSearchParams();
  const schema = schemaOverride || MosyremindersSchema;
  const id = idProp ?? searchParams.get(`${MosyremindersSchema.entity}_dataNode`);
  const form = useEntityFormController(schema, MosyremindersActions, {
    id,
    onDone,
