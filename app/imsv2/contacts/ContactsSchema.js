...
const moduleApi = apiRoutes.contacts.base;

export const ContactsSchema = {
  entity: 'contacts',              // DB table name; also drives default role names
  ...
  importDataEndpoint : apiRoutes.contacts.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/imsv2/contacts/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Contact', icon: 'plus', variant: 'outline-primary', navigateTo: '/imsv2/contacts/profile', grid: true, form: false, rowAction: false },
  ...
  fields: [
    ...
    { key: 'contact_id', label: 'Contact Id', type: 'text', system: true, editable: false },
    { key: 'contact_name', label: 'Contact Name', type: 'text', title: true, required: true },
