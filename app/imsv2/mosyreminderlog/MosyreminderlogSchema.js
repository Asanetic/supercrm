...
const moduleApi = apiRoutes.mosyreminderlog.base;

export const MosyreminderlogSchema = {
  entity: 'mosy_reminder_log',              // DB table name; also drives default role names
                                     // (view_mosyreminderlog / manage_mosyreminderlog) and apiBase
  label: 'Mosyreminderlog',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.mosyreminderlog.import,
  ...
  moduleRole: 'view_mosyreminderlog',
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/imsv2/mosyreminderlog/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this mosyreminderlog?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_mosyreminderlog' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Mosyreminderlog', icon: 'plus', variant: 'outline-primary', navigateTo: '/imsv2/mosyreminderlog/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_mosyreminderlog' },
...
// dyn-btn-accent-teal   { border-color: transparent; color: #0f766e; }
  ...
  // roles: { view: 'view_mosyreminderlog', manage: 'manage_mosyreminderlog' },
};
