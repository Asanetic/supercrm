...
export const PhonebookSchema = {
  ...
  fields: [
    ...
    { key: 'phone', type: 'text', searchable: true },
    { key: 'email', type: 'text', searchable: true },
    { key: 'category', type: 'groupedSelect', endpoint: '/api/novaerpv9/phonebook/list', groupByField: 'category', searchable: true },
