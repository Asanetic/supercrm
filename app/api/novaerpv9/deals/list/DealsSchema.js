...
export const DealsSchema = {
  ...
  fields: [
    ...
    { key: 'deal_title', type: 'text', searchable: true },
    { key: 'deal_description', type: 'textarea', colSpan: 3, searchable: true },
    { key: 'client_id', type: 'text', searchable: true },
    { key: 'deal_source', type: 'text', searchable: true },
    { key: 'deal_value', type: 'money' },
    { key: 'expected_close_date', type: 'datetime' },
    { key: 'pipeline_stage', type: 'text', searchable: true },
    { key: 'deal_stage', type: 'text', searchable: true },
    { key: 'deal_status', type: 'text', searchable: true },
    { key: 'assigned_sales_rep', type: 'text', searchable: true },
    { key: 'priority_level', type: 'text', searchable: true },
    { key: 'deal_probability', type: 'text', searchable: true },
    { key: 'next_follow_up_date', type: 'datetime' },
    { key: 'deal_notes', type: 'textarea', colSpan: 3, searchable: true },
