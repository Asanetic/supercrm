...
export const IncomesourcesSchema = {
  ...
  moduleRole: 'view_income_sources',
  ...
  fields: [
    ...
    { key: 'income_source_id', type: 'text', system: true, editable: false },
    { key: 'name', type: 'text', title: true, required: true, searchable: true },
    { key: 'description', type: 'textarea', colSpan: 3, searchable: true },
    { key: 'income_type', type: 'text', searchable: true },
    { key: 'niche', type: 'text', searchable: true },
    { key: 'default_amount', type: 'money' },
    { key: 'currency', type: 'text', searchable: true },
    { key: 'status', type: 'groupedSelect', endpoint: '/api/imsv2/incomesources/list', groupByField: 'status', searchable: true },
