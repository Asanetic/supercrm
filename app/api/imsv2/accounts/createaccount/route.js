...
export async function GET(request) {
  try {
    ...
    const enhancedParams = {
      tbl: 'system_users',
      colstr: base64Encode(`email`), // default to *
      ...queryParams 
    };
...
export async function POST(MyaccountRequest) {
  ...
  //--- End system_users inputs array --//
    ...
    const mutatedDataArray =MyaccountInputsArr;//mutateInputArray('system_users',MyaccountInputsArr, MyaccountRequest, newId, authData)
