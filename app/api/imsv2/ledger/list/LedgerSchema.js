...
export const LedgerSchema = {
  ...
  fields: [
    ...
    { key: 'ledger_id', type: 'text', system: true, editable: false },
    ...
    { key: 'transaction_date', type: 'datetime' },
    { key: 'due_date', type: 'datetime' },
    { key: 'reference', type: 'text', searchable: true },
    { key: 'description', type: 'textarea', colSpan: 3, searchable: true },
    { key: 'status', type: 'groupedSelect', endpoint: '/api/imsv2/ledger/list', groupByField: 'status', searchable: true },
