...
export const SystemusersSchema = {
  ...
  profileActions: [
    ...
    { key: 'new', label: 'New Systemuser', icon: 'plus', variant: 'outline-primary', navigateTo: '/assetguard/systemusers/profile' },
  ...
  fields: [
    ...
    { key: 'account_status', label: 'Ref Id', type: 'text', searchable: true },
