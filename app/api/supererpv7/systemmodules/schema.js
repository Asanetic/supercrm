...
export const SystemmodulesSchema = {
  ...
  label: 'Systemmodules',                 // optional, defaults to entity capitalized
  apiBase: '/api/assetguard/systemmodules',
  ...
  showInList: ['row_count', 'module_name', 'module_key', 'module_group', 'module_type', 'module_status', 'date_created', 'hive_site_id'],
  ...
  profileActions: [
    ...
    { key: 'new', label: 'New Systemmodule', icon: 'plus', variant: 'outline-primary', navigateTo: '/assetguard/systemmodules/profile', grid: true, form: false, rowAction: false },
    //{ key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_systemmodules' },
  ...
  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['module_name', 'module_key', 'module_group', 'module_type', 'module_status', 'date_created', 'hive_site_id'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['hive_site_name'] },
  ],
  ...
  fields: [
    ...
    { key: 'module_key', label: 'Module Key', type: 'text', searchable: true },
    { key: 'module_group', label: 'Module Group', type: 'text', searchable: true },
    { key: 'module_type', label: 'Module Type', type: 'text', searchable: true },
    { key: 'module_status', label: 'Module Status', type: 'text', searchable: true },
