...
import { DeleteServices } from '../services/ServicesDbGateway';
...
export async function GET(request) {
  ...
  const deleteToken = searchParams.get('_services_delete_record');
  ...
  if (deleteToken) {
    ...
    const res = await DeleteServices(deleteTokenDecode, whereStr);
