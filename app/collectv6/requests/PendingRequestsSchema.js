...
const moduleApi = apiRoutes.pendingrequests.base;

export const PendingRequestsSchema = {
  entity: 'requests',              // DB table name; also drives default role names
                                     // (view_requests / manage_requests) and apiBase
  label: 'Requests',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.pendingrequests.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/collectv6/requests/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this request?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_requests' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Request', icon: 'plus', variant: 'outline-primary', navigateTo: '/collectv6/requests/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_requests' },
  ...
  showInList: ['row_count', 'staff_id', 'request_number', 'amount_requested', 'request_reason', 'amount_approved', 'current_balance', 'requested_on'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['staff_id', 'request_number', 'amount_requested', 'request_reason', 'amount_approved', 'current_balance', 'requested_on'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['staff_id', 'request_number', 'amount_requested', 'request_reason', 'amount_approved', 'current_balance', 'requested_on'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['approved_on', 'paid_on', 'cleared_on', 'request_status', 'request_remarks'] },
  ],
  ...
  fields: [
    ...
    { key: 'request_reason', label: 'Request Reason', type: 'textarea' },
    { key: 'amount_approved', label: 'Amount Approved', type: 'money' },
    { key: 'current_balance', label: 'Current Balance', type: 'money' },
    { key: 'requested_on', label: 'Requested On', type: 'datetime' },
    { key: 'approved_on', label: 'Approved On', type: 'datetime' },
    { key: 'paid_on', label: 'Paid On', type: 'datetime' },
    { key: 'cleared_on', label: 'Cleared On', type: 'datetime' },
    { key: 'request_status', label: 'Request Status', type: 'text' },
    { key: 'request_remarks', label: 'Request Remarks', type: 'textarea', colSpan: 3 },
