...
export default function SystemModuleManifestList({ dataIn = {}, dataOut = {} }) {
  ...
  useEffect(() => {
    ...
    const customFilter = {
      ...
      ...customQueryStr,
      ...MosySecureFilterEngine("system_module_manifest_"),
      
    }
    
    
    loadSystemModuleManifestListData(customFilter, stateItemSetters);
  ...
  function moduleFilterManager(action = "")
  {
    ...
    if(action === "search"){
      ...
      //reset pagination
      mosyUpdateUrlParam(
        "qsystem_module_manifest__page",
        "1"
      );
      
      //set url params
      mosyFilterUrl({tableName:"system_module_manifest_", keyword:stateItem.systemModuleManifestQuerySearchStr, reload:false})
      
      // clear input
      document.getElementById(
        "txt_system_module_manifest_"
      ).value = "";
    ...
    {
      //empty Search String
      stateItemSetters.setSystemModuleManifestQuerySearchStr("");
      ...
      deleteUrlParam("qsystem_module_manifest_")
      deleteUrlParam("system_module_manifest__mosyfilter")
    ...
    <div className={`col-md-12  p-0 m-0  ${showDataControlSections && ("main_list_container")}  `} style={{marginTop: "0px", paddingBottom: "0px"}}>
      ...
      {showDataControlSections && (<div className="row justify-content-end col-md-12 text-right pt-3 pb-3 data_list_section ml-0 mr-0 mb-3 border-bottom pr-0 pl-0" id="">
        ...
        <div className="col-md-6 p-0 text-right hive_list_search_tray">
          ...
          />
          <button className="custom-search-botton" id="qsystem_module_manifest__btn" name="qsystem_module_manifest__btn" type="button" onClick={() => moduleFilterManager("search")}><i className="fa fa-search mr-1"></i> Go </button>
        </div>
        ...
        <div className="row justify-content-end m-0 p-0 col-md-12 hive_list_action_btn_tray" id="">
          ...
          <div className="col-md-12 p-0 hive_list_nav_right_ribbon" id="">
            ...
            <AddNewButton src="SystemModuleManifestList" link={customProfilePath} label="New System Module Manifest " icon="plus-circle" />
            <div
              ...
              <Fragment key={`_row_${listsystem_module_manifest__result.primkey}`}>
                <tr key={listsystem_module_manifest__result.primkey}>
                  <td>
                    <div className="table_cell_dropdown">
                      <div className="table_cell_dropbtn">
                        ...
                        <div className="table_cell_dropdown-content">
                          ...
                          action="_related_pages"
                          label=" Related Pages"
                          icon="list "
                          dataIn={() => viewPageManifest({childCol:`moduleKey`,parentColVal:listsystem_module_manifest__result.module_key,parentName:listsystem_module_manifest__result.module_name})}   // only runs on click now
                          callBack={(incomingRequest) => {setChildDataOut(incomingRequest) }}
                          />
                        </div>
                      </div>
                    ...
                    <td scope="col"><span title={listsystem_module_manifest__result.module_key}>{magicTrimText(listsystem_module_manifest__result._page_manifest__page_url_module_key, 70)}</span></td>
