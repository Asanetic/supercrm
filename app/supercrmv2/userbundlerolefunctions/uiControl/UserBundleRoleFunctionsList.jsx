              ...
              <Fragment key={`_row_${listuser_bundle_role_functions_result.primkey}`}>
                <tr key={listuser_bundle_role_functions_result.primkey}>
                  <td>
                    <div className="table_cell_dropdown">
                      <div className="table_cell_dropbtn">
                        ...
                        <div className="table_cell_dropdown-content">
                          ...
                          action="_bundle_details"
                          label=" Bundle Details"
                          icon="list "
                          dataIn={() => viewSystemRoleBundles({childCol:`bundleId`,parentColVal:listuser_bundle_role_functions_result.bundle_id,parentName:listuser_bundle_role_functions_result.role_name})}   // only runs on click now
                          callBack={(incomingRequest) => {setChildDataOut(incomingRequest) }}
                          />
                        </div>
                      </div>
                    ...
                    <td scope="col"><span title={listuser_bundle_role_functions_result.bundle_id}>{magicTrimText(listuser_bundle_role_functions_result._system_role_bundles_bundle_name_bundle_id, 70)}</span></td>
