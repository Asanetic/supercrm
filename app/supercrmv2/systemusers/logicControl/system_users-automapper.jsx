/**
 * Final FILE: system_users-automapper.jsx
...
// PURPOSE : Open Project Users modal
// ════════════════════════════════════════════════════════════════
export function viewSystemUsers({
    childCol,
    parentColVal,
    parentName
}) {
    ...
    MosyCard(
        ...
        <div className="col-md-12 p-0" id="modal4">
            ...
            >
                ...
                <a
                    href={`../systemusers/list?system_users_mosyfilter=${btoa(`${childCol}='${btoa(parentColVal)}'`)}`}
