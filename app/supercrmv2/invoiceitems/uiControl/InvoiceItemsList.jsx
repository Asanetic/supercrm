                    ...
                    <div className="table_cell_dropdown">
                      <div className="table_cell_dropbtn">
                        ...
                        <div className="table_cell_dropdown-content">
                          ...
                          icon="list "
                          dataIn={() => viewInvoices({childCol:`recordId`,parentColVal:listinvoice_items_result.invoice_id,parentName:listinvoice_items_result.invoice_item_name})}   // only runs on click now
                          callBack={(incomingRequest) => {setChildDataOut(incomingRequest) }}
                          />
                          <MosyGridRowOptions
                          src="InvoiceItemsList"
                          ...
                          icon="list "
                          dataIn={() => viewServices({childCol:`recordId`,parentColVal:listinvoice_items_result.item_id,parentName:listinvoice_items_result.invoice_item_name})}   // only runs on click now
                          callBack={(incomingRequest) => {setChildDataOut(incomingRequest) }}
                          />
                        </div>
                      </div>
