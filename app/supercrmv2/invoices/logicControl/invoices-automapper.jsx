/**
 * Final FILE: invoices-automapper.jsx
    ...
    MosyCard(
        ...
        <div className="col-md-12 p-0" id="modal4">
            ...
            >
                ...
                <a
                    href={`../invoices/list?invoices_mosyfilter=${btoa(`${childCol}='${btoa(parentColVal)}'`)}`}
