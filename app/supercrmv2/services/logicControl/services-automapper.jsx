/**
 * Final FILE: services-automapper.jsx
...
// PURPOSE : Open Service detail modal
// ════════════════════════════════════════════════════════════════
    ...
    MosyCard(
        ...
        <div className="col-md-12 p-0" id="modal4">
            ...
            >
                ...
                <a
                    href={`../services/list?services_mosyfilter=${btoa(`${childCol}='${btoa(parentColVal)}'`)}`}
