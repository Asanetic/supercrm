...
// ════════════════════════════════════════════════════════════════
// Imports from send-payment-reminder-msg.jsx
import {
  sendReminderMessage
              ...
              <div className="col m-0 p-0 pb-3">
                
                {
                  expected_revenueNode?.primkey ? (
                    ...
                    <span>{`Expected Revenue / ${expected_revenueNode?.revenue_title}`}</span>
      ...
      <div className="col-md-12 row p-0 justify-content-center p-0 m-0">
        <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
          ...
          <div className="row justify-content-start col-md-12 p-0 m-0 ">
            ...
            value={expected_revenueNode?.payment_status || ""}
            onChange={handleInputChange}
            context={{ hostParent: hostParent  }}
            inputOverrides={{}}
            type="text"
        ...
        <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
          ...
          <div className="row justify-content-start col-md-12 p-0 m-0 ">
            ...
            value={expected_revenueNode?.probability_percent || ""}
            onChange={handleInputChange}
            context={{ hostParent: hostParent  }}
            inputOverrides={{}}
            type="text"
            ...
            <input className="form-control" id="lead_id" name="lead_id" value={expected_revenueNode?.lead_id || ""} placeholder="Lead Id" type="hidden"/>
            ...
            value={expected_revenueNode?.revenue_status || ""}
            onChange={handleInputChange}
            context={{ hostParent: hostParent  }}
            inputOverrides={{}}
            type="text"
            ...
            <input className="form-control" id="assigned_to" name="assigned_to" value={expected_revenueNode?.assigned_to || ""} placeholder="Assigned To" type="hidden"/>
            ...
            {expected_revenueNode?.primkey && (
              <div className="form-group col-md-4 hive_data_cell  ">
                <label >Name</label>
                <div className="border border_set p-2 rounded_medium form-control pt-3" id="div_name" name="div_name" placeholder="Name">{expected_revenueNode?.name || ""}</div>
              </div>)}
              
              {expected_revenueNode?.primkey && (
                <div className="form-group col-md-4 hive_data_cell  ">
                  <label >Tel</label>
                  <div className="border border_set p-2 rounded_medium form-control pt-3" id="div_tel" name="div_tel" placeholder="Tel">{expected_revenueNode?.tel || ""}</div>
                </div>)}
                
                {expected_revenueNode?.primkey && (
                  <div className="form-group col-md-4 hive_data_cell  ">
                    <label >Email</label>
                    <div className="border border_set p-2 rounded_medium form-control pt-3" id="div_email" name="div_email" placeholder="Email">{expected_revenueNode?.email || ""}</div>
                  </div>)}
                </div>
