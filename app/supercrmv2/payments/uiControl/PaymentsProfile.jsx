...
// ════════════════════════════════════════════════════════════════
// Imports from send-payment-receipt-msg.jsx
import {
  sendAckMessage
} from '../logicControl/send-payment-receipt-msg';
              ...
              <div className="col m-0 p-0 pb-3">
                
                {
                  paymentsNode?.primkey ? (
                    ...
                    <span>{`Payments / ${paymentsNode?.payment_for}`}</span>
        ...
        <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
          ...
          <div className="row justify-content-start col-md-12 p-0 m-0 ">
            ...
            {paymentsNode?.primkey && (
              <div className="form-group col-md-4 hive_data_cell  ">
                <label >Name</label>
                <div className="border border_set p-2 rounded_medium form-control pt-3" id="div_name" name="div_name" placeholder="Name">{paymentsNode?.name || ""}</div>
              </div>)}
              
              {paymentsNode?.primkey && (
                <div className="form-group col-md-4 hive_data_cell  ">
                  <label >Tel</label>
                  <div className="border border_set p-2 rounded_medium form-control pt-3" id="div_tel" name="div_tel" placeholder="Tel">{paymentsNode?.tel || ""}</div>
                </div>)}
                
                {paymentsNode?.primkey && (
                  <div className="form-group col-md-4 hive_data_cell  ">
                    <label >Email</label>
                    <div className="border border_set p-2 rounded_medium form-control pt-3" id="div_email" name="div_email" placeholder="Email">{paymentsNode?.email || ""}</div>
                  </div>)}
                </div>
