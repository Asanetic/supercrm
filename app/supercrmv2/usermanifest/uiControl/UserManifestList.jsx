              ...
              <Fragment key={`_row_${listuser_manifest__result.primkey}`}>
                <tr key={listuser_manifest__result.primkey}>
                  <td>
                    <div className="table_cell_dropdown">
                      <div className="table_cell_dropbtn">
                        ...
                        <div className="table_cell_dropdown-content">
                          ...
                          action="_user_details"
                          label=" User Details"
                          icon="list "
                          dataIn={() => viewSystemUsers({childCol:`recordId`,parentColVal:listuser_manifest__result.user_id,parentName:listuser_manifest__result.user_name})}   // only runs on click now
                          callBack={(incomingRequest) => {setChildDataOut(incomingRequest) }}
                          />
                        </div>
                      </div>
                    ...
                    <td scope="col"><span title={listuser_manifest__result.user_id}>{magicTrimText(listuser_manifest__result._system_users_name_user_id, 70)}</span></td>
