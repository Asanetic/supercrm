            ...
            <div className="col-md-12 row p-0 justify-content-center p-0 m-0">
              <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
                ...
                <div className="row justify-content-start col-md-12 p-0 m-0 ">
                  ...
                  value={settingsNode?.default_currency || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
                  ...
                  value={settingsNode?.sms_notifications || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
                  ...
                  value={settingsNode?.email_notifications || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
                  ...
                  <MosySmartField
                  module="settings"
                  field="allow_partial_payments"
                  label="Allow Partial Payments"
                  value={settingsNode?.allow_partial_payments || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
                  ...
                  <MosySmartField
                  module="settings"
                  field="allow_partial_recoveries"
                  label="Allow Partial Recoveries"
                  value={settingsNode?.allow_partial_recoveries || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
                  ...
                  <MosySmartField
                  module="settings"
                  field="auto_generate_request_numbers"
                  label="Auto Generate Request Numbers"
                  value={settingsNode?.auto_generate_request_numbers || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
              ...
              <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
                ...
                <div className="row justify-content-start col-md-12 p-0 m-0 ">
                  ...
                  field="system_status"
                  label="System Status"
                  value={settingsNode?.system_status || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
