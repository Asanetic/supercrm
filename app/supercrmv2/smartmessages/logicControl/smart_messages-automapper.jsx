/**
 * Final FILE: smart_messages-automapper.jsx
...
// ════════════════════════════════════════════════════════════════
// FUNCTION: viewSmartMessages
// PURPOSE : Open Message history modal
// ════════════════════════════════════════════════════════════════
export function viewSmartMessages({
    childCol,
    parentColVal,
    parentName
}) {
    ...
    MosyCard(
        ...
        <div className="col-md-12 p-0" id="modal4">
            ...
            >
                ...
                <a
                    href={`../smartmessages/list?smart_messages_mosyfilter=${btoa(`${childCol}='${btoa(parentColVal)}'`)}`}
