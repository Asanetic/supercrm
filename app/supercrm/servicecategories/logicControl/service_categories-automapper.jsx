/**
 * Final FILE: service_categories-automapper.jsx
...
// PURPOSE : Open Parent Category modal
// ════════════════════════════════════════════════════════════════
export function viewServiceCategories({
    childCol,
    parentColVal,
    parentName
}) {
    ...
    MosyCard(
        ...
        <div className="col-md-12 p-0" id="modal4">
            ...
            <ServiceCategoriesList
                ...
                dataOut={{
                    setChildDataOut:
                        InteprateServiceCategoriesEvent
                }}
            />
            ...
            >
                ...
                <a
                    href={`../servicecategories/list?service_categories_mosyfilter=${btoa(`${childCol}='${btoa(parentColVal)}'`)}`}
