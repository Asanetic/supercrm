...
//data
import { loadServiceCategoriesListData, popDeleteDialog, InteprateServiceCategoriesEvent  } from '../dataControl/ServiceCategoriesRequestHandler';
...
export default function ServiceCategoriesList({ dataIn = {}, dataOut = {} }) {
  ...
  useEffect(() => {
    ...
    loadServiceCategoriesListData(customFilter, stateItemSetters);
  ...
  function moduleFilterManager(action = "")
  {
    ...
    {
      //empty Search String
      stateItemSetters.setServiceCategoriesQuerySearchStr("");
      ...
      //refresh list
      loadServiceCategoriesListData(customQueryStr, stateItemSetters);
