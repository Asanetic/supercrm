                    ...
                    <div className="table_cell_dropdown">
                      <div className="table_cell_dropbtn">
                        ...
                        <div className="table_cell_dropdown-content">
                          ...
                          <MosyGridRowOptions
                          src="SystemUsersList"
                          action="_project_pages"
                          label=" Project Pages"
                          icon="list "
                          dataIn={() => viewPageManifest({childCol:`projectId`,parentColVal:listsystem_users_result.project_id,parentName:listsystem_users_result.name})}   // only runs on click now
                          callBack={(incomingRequest) => {setChildDataOut(incomingRequest) }}
                          />
                          <MosyGridRowOptions
                          src="SystemUsersList"
                          ...
                          label=" User Access"
                          icon="list "
                          dataIn={() => viewUserManifest({childCol:`userId`,parentColVal:listsystem_users_result.record_id,parentName:listsystem_users_result.name})}   // only runs on click now
                          callBack={(incomingRequest) => {setChildDataOut(incomingRequest) }}
                          />
                        </div>
                      </div>
