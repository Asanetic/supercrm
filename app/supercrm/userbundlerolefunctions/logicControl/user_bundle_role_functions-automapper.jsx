/**
 * Final FILE: user_bundle_role_functions-automapper.jsx
...
// ════════════════════════════════════════════════════════════════
// FUNCTION: viewUserBundleRoleFunctions
// PURPOSE : Open Role Functions modal
// ════════════════════════════════════════════════════════════════
export function viewUserBundleRoleFunctions({
    childCol,
    parentColVal,
    parentName
}) {
        ...
        <div className="col-md-12 p-0" id="modal4">
            ...
            <UserBundleRoleFunctionsList
                dataIn={{
                    ...
                    customProfilePath:
                        '../userbundlerolefunctions/profile',
                ...
                dataOut={{
                    setChildDataOut:
                        InteprateUserBundleRoleFunctionsEvent
                }}
            />
            ...
            >
                ...
                <a
                    href={`../userbundlerolefunctions/list?user_bundle_role_functions_mosyfilter=${btoa(`${childCol}='${btoa(parentColVal)}'`)}`}
