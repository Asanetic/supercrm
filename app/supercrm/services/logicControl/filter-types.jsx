...
// ════════════════════════════════════════════════════════════════
// FUNCTION: filterBillingType
// ════════════════════════════════════════════════════════════════
export function filterBillingType({title, customQueryStr, stateItemSetters,parentColName, parentTableName}) 
{
    //alert("filterBillingType");
