/**
 * Final FILE: quotations-automapper.jsx
    ...
    MosyCard(
        ...
        <div className="col-md-12 p-0" id="modal4">
            ...
            >
                ...
                <a
                    href={`../quotations/list?quotations_mosyfilter=${btoa(`${childCol}='${btoa(parentColVal)}'`)}`}
