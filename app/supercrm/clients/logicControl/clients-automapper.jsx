/**
 * Final FILE: clients-automapper.jsx
...
// PURPOSE : Open Client Details modal
// ════════════════════════════════════════════════════════════════
    ...
    MosyCard(
        ...
        <div className="col-md-12 p-0" id="modal4">
            ...
            >
                ...
                <a
                    href={`../clients/list?clients_mosyfilter=${btoa(`${childCol}='${btoa(parentColVal)}'`)}`}
