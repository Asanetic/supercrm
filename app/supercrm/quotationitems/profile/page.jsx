...
import QuotationItemsProfile from '../uiControl/QuotationItemsProfile';
...
export async function generateMetadata({ searchParams }) {
  ...
  return {
    ...
    description: 'supercrm Quotation Items',
...
export default function QuotationItemsMainProfilePage() {
          ...
          <div className="page-wrapper">
             <div className="content container-fluid p-0 m-0 ">
               <Suspense fallback={<div className="col-md-12 p-5 text-center h3">Loading...</div>}>
                 <QuotationItemsProfile 
                    dataIn={{ parentUseEffectKey: "initQuotationItemsProfile" }} 
