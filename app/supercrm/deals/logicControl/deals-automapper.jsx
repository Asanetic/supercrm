/**
 * Final FILE: deals-automapper.jsx
...
// ════════════════════════════════════════════════════════════════
// FUNCTION: viewDeals
// PURPOSE : Open Deal Details modal
// ════════════════════════════════════════════════════════════════
export function viewDeals({
    childCol,
    parentColVal,
    parentName
}) {
    ...
    MosyCard(
        ...
        <div className="col-md-12 p-0" id="modal4">
            ...
            >
                ...
                <a
                    href={`../deals/list?deals_mosyfilter=${btoa(`${childCol}='${btoa(parentColVal)}'`)}`}
