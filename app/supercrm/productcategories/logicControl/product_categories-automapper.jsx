/**
 * Final FILE: product_categories-automapper.jsx
...
// ════════════════════════════════════════════════════════════════
export function viewProductCategories({
    childCol,
    parentColVal,
    parentName
}) {
    ...
    MosyCard(
        ...
        <div className="col-md-12 p-0" id="modal4">
            ...
            <ProductCategoriesList
                ...
                dataOut={{
                    setChildDataOut:
                        InteprateProductCategoriesEvent
                }}
            />
            ...
            >
                ...
                <a
                    href={`../productcategories/list?product_categories_mosyfilter=${btoa(`${childCol}='${btoa(parentColVal)}'`)}`}
